...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Oops!');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Krampus/And_Checking_It_Twice.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'I thought he had forgotten about me. I thought I was safe. That was the cruelest part. Thinking I''d gotten away...');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"You will pay dearly, maybe not today, but you cannot hide from me forever... I will find you, I always find you."');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Elrick_The_Lich_King/Avalanche.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'There are many dangers in the Frostbyte Reach not related to liches or armies of the undead or monsters. The weight of snow and the pressing cold can stop a hero just as dead.');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Red_Back_2.0.png', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"THIS is what I meant to do. Terminal OVerdrive BLAM! BLAM! BLAM! AHHH! HEHEHEHEHEHE!"');
...
insert into ChallengeAssignments (CharacterIndex, ChallengeIndex) VALUES (944, 9); --Gnomish Excavator
...
insert into AbilityAssignments (AbilityIndex, ChallengeTrapIndex) VALUES (2279, 10); --Blistering Armor
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"My dear child, your companions seem to have hoarded all my stolen treasures for themselves. It is only logical then that I aim this rather nasty invention at you."');
...
insert into ChallengeAssignments (CharacterIndex, ChallengeIndex) VALUES (944, 11); --Gnomish Excavator
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', ''); --!! unavailable !!
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Elrick_The_Lich_King/Call_to_Battle.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Elrik raised his sword and let out a call that, from a mortal throat, would have been a fearsome warcry. But from his decayed body the screeching croak almost bubbled into dark laughter.');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Purple_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Thresher_The/Contest_of_Strength.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Each swing of the Thresher''s flail can rattle loose enough seed to plant a farmer''s back forty, or flatten a fully armored knight like a tin milking pail stepped on by a bull.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Was it a right, right, left? Or a right, left, right? Can you ask that funny looking fellow gimping towards us if he knows a way out?"');
...
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Dark_Alchemy.xhtml', 
...
'http://htkb.info/SDE/2.0/Pet_Parade/Cards/Arcade/Challenges/Card_Challenge_Back_2.0_PP.png', 
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Dark_Beacon.xhtml', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'It is expected of a guest to bring the host a gift.');
...
'http://htkb.info/SDE/2.0/Pet_Parade/Cards/Arcade/Challenges/Card_Challenge_Back_2.0_PP.png', 
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Deadly_Dance_The.xhtml', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Warning: severe irritation of the skin and eyes may occur. Seek an apothecary immediately if you experience any of the following: nausea, swollen tongue, headache, visions of the great void beyond the veil of the mortal realm, stomach ache..."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The practice of Ushi-no-Toki-Mairi must always be kept secret and away from watchful eyes or it will not take effect, and the target of the curse will escape justice.');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Boss_Challenges/Hoarfang/Card_Boss_Challenge_Dragons_Rage_2.0.png', 
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Never challenge a dwarf in a contest of drink." - Crystalian Proverb'); 
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Elrick_The_Lich_King/Endless_Tide_The.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Never dying, never sleeping, they marched on...');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Stooping low to scrape up bushels of straw, the Thresher can quickly repair depleted limbs and gain resistance to deadly blows. It''s as if the act of stuffing its ragged coat is like slipping on a fresh coat of mail.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Wait. Wait. Wait! Time out! Can''t you see the condenser coil''s busted? Hand me that crystal.... There we go. Fight starts again on ''3''."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Curse you! Ack!"<br><br>-- unknown betrayed');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Of course they''re afraid of fire. Any adventurer who wants to put some distance between themselves and an advancing horde of straw and malice need only to light a torch and wave it about!" - Unknown Adventurer'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"You''ve gravely misread the situation."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Mugg! Look at dis one scamper. Shoot it up gud!"'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Having rounded up the bedraggled carcasses of Crows who flew too close to an angry field, a welter of dark magic can often be summoned to return these bothersome avians to a horrible parody of flapping unlife.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Impressed? I know you are! But it gets better, folks. I know, I know, I''m practically cutting me own throat here. But for just a few more coins you can upgrade to the deluxe model..."');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Elrick_The_Lich_King/Freezing_March_The.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Marching an army across the frozen wastes would normally be impossible. But an army of the undying can face perils that a mortal army would not dare cross, allowing them to strike from unlikely places.');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Elrick_The_Lich_King/Frozen_Shield.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'So cold is Elrik''s heart that the ice itself rises to protect him. A frozen shield before him and a crown of ice upon his head, he marches to war.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"When I overcharge the crystal core a reac-- Oh. It''s all terribly techinical and you don''t look very bright. It is suffice to say, I will be taking your Princess Coins after this."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The Hitodama of a spirit burn with the ghostly flame as bright as the rage of the Yurei they are part of.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The Guth enjoys physical games of strength almost as much as battle. He has even been known to allow enemies a brief moment of peace in order compete. The stakes are simple. If he wins, he gets to fight you. If he loses, he gets to eat you.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Oh, you think the slop is your ally. But you merely adopted the slop; I was born in it, molded by it... anyway, are you gonna eat that?"');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Once the contagion has spread wide enough, walking the dimly lit fields can be a harrowing experience. Though the farmers have all fled, why is it then that the harvest still came and went, and who is neatly baling up all the straw and hay? Pray then that no one gets curious enough to look inside the bales. More than a few of the missing farm hands can be found packed neatly inside.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'But how? How does he see me when I''m sleeping?<br><br>Is it magic? Does he have a crystal ball?<br><br>I''M NEVER SLEEPING AGAIN!');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The air is palpable with the rage of the Yurei''s drowned warriors, this has an energizing effect on the lost and wandering spirits of Kagejima.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The guilt of mortal sin lies heavy on the hearts of the righteous. It is like a fragrant lure to the Yurei, and food for their empty, ravenous souls.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Told you not to stand under that pipe. Say, in the market for some new clothes?"');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Elrick_The_Lich_King/Icy_Resolve.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Normal foes become enraged and make mistakes. They become arrogant and underestimate you. Elrik looks through your soul with cold calculation, and knows how he plans to slay you.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The Lady of Deceit''s greatest skill is to spin truth into her web of lies until the difference is indiscernable. Thus entangled, she deftly weaves threads of chaos into the fabric of adventuring parties and nations alike.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"See how the shell expands into that mass of tangling wires. The real genius is the rectractor core at the center. It cinches everything together nice and tight."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"I have my trainee Dunces make these. It''s why I installed this retractable blast shield around my cockpit."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Did you really think that after countless ''heroes'' invaded my home, that I wouldn''t have a plan for the eventuality that you reached my lab? Now. Stand still. I need to push this red button."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'I don''t even know how he fits down that chimney...');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'To be in the presence of Demon Queen Araphel is to be confronted by such staggering demonic majesty that the senses reel and one''s own body betrays them.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'There are no rules to follow, no logic to trace back, no mystery to solve. You simply have 7 days... and then you die.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"So you''re telling me you just found this sword in the dungeon? Just laying there, discarded. It''s not a family heirloom? No? Eh. Bet I can do is a few coppers. Decide now and I throw in the lucky rat tail. Tick-tock."');
...
'http://htkb.info/SDE/2.0/Pet_Parade/Cards/Arcade/Challenges/Card_Challenge_Back_2.0_PP.png', 
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Might_Makes_Right.xhtml', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Oh dear. It wasn''t actually supposed to do that. Watch out please, while I attempt to regain control."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The servants of the Dark Queen are never far from hand, and they are eager to bring new followers into service.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Nothing in heaven or on earth can keep me from my revenge."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The cultists that help to usher in the rise of strawmen constructs will often talk of a prophecy when the very fields will one day draw back like a curtain, and an army will stand in its place, as far as the eye can see, to bring to ruin the Kingdom and herald in the Dark Consul''s reign.');
...
'http://htkb.info/SDE/2.0/Pet_Parade/Cards/Arcade/Challenges/Card_Challenge_Back_2.0_PP.png', 
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Overwhelm.xhtml', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"This is just standard respect, the Prince''s Dues must be paid. Now, I''m not saying you get nothing for your money. You get protection. It''s dangerous down here. All manner o'' ways to get yerself dead..."');
...
'http://htkb.info/SDE/2.0/Pet_Parade/Cards/Arcade/Challenges/Card_Challenge_Back_2.0_PP.png', 
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Pick_Off_the_Stragglers.xhtml', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The children who grow up around pumpkin patches, during times of harvest, will often carve intricate faces and leering scary grimaces as part of their celebration. If you watch this tradition, a keen eyed observer will also note the drawing of straws. The one that draws the short straw is the one that goes into the patch to pick first.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'It is easy to assume The Guth is a mindless monster bent only towards destruction and combat. But it is a foolish Hero that does so. The Guth is capable of surprisingly complex strategies and cunning tactics - so long as the end result is destruction and combat.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Eating goblins is generally frowned upon in Undercove, and Frostbyte, and, well everywhere really. It''s not very nice. Nor is it very healthy. But, in a rare pause between trading blows, The Destroyer introduced The Guth to "juicing" as a healthy alternative.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'There is a simple elegance in a hate so wretched it follows you from the next world.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'It''s not only about eating. It''s also about the pure joy of swinging an axe around bashing stuff, bellowing at the top of your lungs, frothing, and laughing. A good romp should be angry. But most of all - it should be fun.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Did you read the fine print, there? The selling party, that''d be me, shall not be held accountable by the injured party, that''d be you, for any of the following: missing fingers, gouged eyes, scraped knees, burst pancreas (oof, that one''s a doozy), broken limbs, hurt feelings, skull fractures..."');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Elrick_The_Lich_King/Skeletal_Hands_At_Your_Ankles.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Stomp the finger bones! STOMP THE FINGER BONES!"');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Stolen goods? Of course they''re stolen! Means they''re quality. People part with their garbage intentionally. The real finds are in the things they part with unintentionally. Why, I should charge more for stolen goods!"');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Elrick_The_Lich_King/Stuck_In_The_Snow.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Oi! Got me leg caught in that snowdrift and when I pulled it out, it sucked me boot right off! These are me boots o'' escaping, too!"');
...
'http://htkb.info/SDE/2.0/Pet_Parade/Cards/Arcade/Challenges/Card_Challenge_Back_2.0_PP.png', 
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Surprise_Assault.xhtml', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'The Stinky Spikers displeased The Guth by refusing to bathe, becoming filthy and diseased. So he ate them. They proved to be remarkably tender and well-aged, if a bit rough to the insides.'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'A clever Spiker named Wicked thought to stave off his demise by becoming unpalatable to The Guth and his hogs by slathering himsef in hotsauce and filling his ears and trousers with chilis. Inadvertently, he created the Guth-favorite appetizer, "Wicked-Style".'); 
...
'http://htkb.info/SDE/2.0/Pet_Parade/Cards/Arcade/Challenges/Card_Challenge_Back_2.0_PP.png', 
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Theyre_in_the_Room.xhtml', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Also known as the Mistress of Chains, Araphel''s commands, no matter how dire, are irresistable when she bends full force of her will towards a binding.');
...
'http://htkb.info/SDE/2.0/Pet_Parade/Cards/Arcade/Challenges/Card_Challenge_Back_2.0_PP.png', 
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Those_Left_Behind.xhtml', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Just because I am Queen does not mean I cannot also be your executioner. Kneel and pay the price for your misguided attempt at defiance."');
...
'http://htkb.info/SDE/2.0/Pet_Parade/Cards/Arcade/Challenges/Card_Challenge_Back_2.0_PP.png', 
'http://htkb.online/SDWiki/SDE/2.0/PP/Cards/Challenges/Tiny_Hands_Burst_From_the_Floor.xhtml', 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Home is where the heart is, as they say. It just so happens my heart is filthy and black and filled with sewage."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Ugg! Look at dem ''eroes all smug."<br><br>"Mugg! Yer right. We needs some jelly."<br><br>"HUUUUUGS!!"'); 
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Minions are easily influenced by the actions of their boss. The Guth, whose inclination is towards wanton mayhem ignites the same in his warriors. This leads to chaotic surges of violence that can be almost impossible to contain.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"I see you have found my succubi. Let them relieve you of your burdens. We will talk after."');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"I installed this tread to climb the vertical surface of rocky terrain. Bother. That is a lie. I installed it for exactly this reason. AHAHAHAHAHAHA!"');
...
'http://htkb.info/SDE/2.0/Cards/Arcade/Challenges/Backs/Card_Boss_Challenge_Blue_Back_2.0.png', 
'http://htkb.online/SDWiki/SDE/2.0/Arcade/Cards/Challenge_Cards/Boss_Challenges/Elrick_The_Lich_King/Withering_Wastes_The.xhtml', 
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'Erik''s land is a blasted place. Cold and frozen like his soul. Little makes a life there, and what does is as vicious and as stalwart as the Lich King himself.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'If you cry, he''ll hear you. Then he''ll see you. Then he''ll taste you.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', 'For some people this time of year is all merry songs and snowmen and warm cocoa. For me? It''s looking over my shoulder and jumping at every sound.');
...
'Challenge', '2.0', '2.0 Core Set', 'Arcade', '"Of course this is a fair deal! Strong-arm you, why I never?! Knuckles, are we strong-arming these weary travelers?"');
