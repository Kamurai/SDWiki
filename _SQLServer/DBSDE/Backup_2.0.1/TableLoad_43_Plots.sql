...
--Armies from the Grave	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Plots (CardIndex, PowerUp, Plot) VALUES (cXXX, '', 
...
--Blessings of Strength	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
--Brain Leeches	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Plots (CardIndex, PowerUp, Plot) VALUES (cXXX, 'Spawn four Skull Points of monsters.', 
...
--Call the Lightning	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
--Flood the Dungeon	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Plots (CardIndex, PowerUp, Plot) VALUES (cXXX, 'Spawn two Skull Points of monsters.', 
...
--Highway Robbery	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Plots (CardIndex, PowerUp, Plot) VALUES (cXXX, 'Spawn three Skull Points of monsters.', 
...
--Immortality Potion	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Plots (CardIndex, PowerUp, Plot) VALUES (cXXX, 'Spawn two Skull Points of monsters.<br><br>Spawn mini-boss.', 
...
--Life for Life	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
--Obscenity Against the Goddess	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
--Path of Champions	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
--Servants of the Consul	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
--Spies in Every Corner	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
--Terrible Protection	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
--Untouchable Tower, The	--CardIndex cXXX --PlotIndex pXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
