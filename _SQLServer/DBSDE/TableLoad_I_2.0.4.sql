...
--Fire Breath Potion --CardIndex 2360 --EquipmentIndex 787
...
insert into Equipment (CardIndex, EquipmentType, Position, Effect) VALUES (2360, 'Character Relic', 'Top', '+1 DEX'); 
...
--Icy Armor Potion --CardIndex 2361 --EquipmentIndex 788
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Icy Armor Potion',
...
insert into Equipment (CardIndex, EquipmentType, Position, Effect) VALUES (2361, 'Character Relic', 'Bottom', '+1 ARM'); 
...
--Invulnerability Potion --CardIndex 2362 --EquipmentIndex 789
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
...
insert into Equipment (CardIndex, EquipmentType, Position, Effect) VALUES (2362, 'Character Relic', 'Left', ''); 
...
--Speed Potion --CardIndex 2363 --EquipmentIndex 790
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Speed Potion',
...
insert into Equipment (CardIndex, EquipmentType, Position, Effect) VALUES (2363, 'Character Relic', 'Right', '+2MO'); 
