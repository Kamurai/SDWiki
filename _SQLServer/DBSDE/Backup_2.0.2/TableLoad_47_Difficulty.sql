...
--Coin on a String	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'Once per turn, during power-up, the party may discard four loot cards from the backpack to gain a Princess Coin.');

--Come Prepared	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'At the start of the game, draw a number of loot cards equal to the twice the number of Heroes. Each Hero may immediately choose and equip one of these loot cards, discard the rest.');

--Deluxe Glitter Bomb	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'Keep this card. Once per game, the party may discard this card at the start of the Consul Turn. The Consul ignores all commands this turn that do not spawn monsters.');

--Know Your Enemy	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'Do not draw a plot card when the first spawning point is destroyed; only draw a plot when directed to by the Mighty Monster Chart.<br><br>If the plot requires placing crystal tokens, after every crystal token is placed, the party may move each crystal token up to four squares.');

--Potion of Luck	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'After the party draws a challenge card, any Hero may discard a potion token to discard the challenge card before it has any effect and draw a new challenge card.');

--Consul's Right Hand, The	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'Select an additional mini-boss. At the start of the Consul''s turn 8, spawn the selected mini-boss.<br><br>If your collection contains only one mini-boss, discard this card and draw again.');

--Excessive Traps	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'Starting on turn 5, during the power-up of every Consul Turn, draw a challenge card and immediately resolve its trap effect if it has one, then discard it with no further effect. Discard this Hard Mode card when the dungeon boss spawns; it has no further effect.');

--Gifted Apprentice, A	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'All mini bosses gain the following bonuses:<br><br>+1ST ARM +1AC');

--Plots Within Plots	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'Draw a plot card during the Consul''s power-up on turn 8. You may have more than one plot card in play at once. If both plot cards make use of crystal tokens, use another distinct token (such as a Fire token) to mark the crystal tokens associated with the second plot. Crystal tokens from the first plot will not affect the second plot, and vice versa.');

--Rising Darkness, The	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (dXXX, 'The dungeon boss gains the following bonuses:<br><br>+1ST STR +1AC');

--They Knew We Were Coming...	--CardIndex cXXX --DifficultyIndex dXXX
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
