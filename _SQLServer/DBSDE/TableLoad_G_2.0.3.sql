...
/*Heart Strike				--Index 1149*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Heart Strike', 		'TBD.');
/*Ice Fiends				--Index 1150*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Ice Fiends', 			'When this model achiees a critial success, summon one Frost Imp adjacent to it if there are fewer than six Frost Imps in play.');

/*Chip Off The Block		--Index 1151*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Chip Off The Block', 	'When a model with Chip Off The Block suffers a critical from an enemy''s offensive action, spawn a Frost Imp within three squares of it (up to a maximum of six Frost Imps in play).');

/*Serving Size				--Index 1152*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Serving Size', 		'When equipped, place 6 tokens on this Treasure card, to represent 6 servings.  When the last token is discarded, discard this Treasure.');
/*Mystery Meat				--Index 1153*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Mystery Meat', 		'AUGMENT, 1RG, Discard a token from this Treasure card and roll 1G.  Heal 1 for each star rolled.  If HE-PO is rolled, the target suffers POISON.');
...
/*Freezing Wind														--Index 2221*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Freezing Wind', 									'Action', 'Support', 	0, -1, -1, 'Wave 3, Push 3, ICE, KNOCKDOWN'); --!!!
/*Frostbite															--Index 2222*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Frostbite', 										'Action', 'Support', 	0, -1, -1, 'Wave 3, BANE, POISON, ICE'); --!!!

/*Dun Dun, Nom Nom													--Index 2223*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Dun Dun, Nom Nom', 								'Action', 'Offense', 	1, 1, 1, '1SW, POUNCE.');

/*Top Sail Pounce													--Index 2224*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Top Sail Pounce', 								'Action', 'Offense', 	2, 4, 1, '1MI, +1R DEX, POUNCE');
/*Sanguine Blade													--Index 2225*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Sanguine Blade', 								'Action', 'Offense', 	2, 4, 1, '1MI, +3B DEX, HEART STRIKE');
/*Epic Duel															--Index 2226*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Epic Duel', 										'Action', 'Support', 	1, -1, 6, '6RG, Until the affected model inflicts a wound on Dread Scarlett, it may only target Dread Scarlett.');
/*Run Red															--Index 2227*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Run Red', 										'Action', 'Support', 	1, -1, -1, 'All other friendly Pirates on this tile may immediately move two squares.');
/*Crimson Port														--Index 2228*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Crimson Port', 									'Potion', 'Emergency', 	1, -1, 0, 'AUGMENT, HEAL 1, BACKSTABBER');

/*Textbook Curse													--Index 2229*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Textbook Curse', 								'Action', 'Offense', 	2, 3, 1, '4MA, +1R WILL, BANE');
/*Let's Discuss Our Plan											--Index 2230*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Let''s Discuss Our Plan', 						'Action', 'Support', 	1, -1, 6, 'AUGMENT, LEADERSHIP');
/*Ultra Caffeinated Cramming Potion									--Index 2231*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Ultra Caffeinated Cramming Potion', 				'Potion', 'Support', 	1, -1, 0, 'AUGMENT, +1AC, suffer 1 wound.');
/*Memorized Healing Potion											--Index 2232*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Memorized Healing Potion', 						'Potion', 'Emergency', 	1, -1, 0, 'AUGMENT, HEAL 1 for each spawning point that has been destroyed this game.');

/*SparkleBOOM														--Index 2233*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'SparkleBOOM', 									'Action', 'Offense', 	2, 3, 8, '8MA, BURST 1, KNOCKDOWN');
/*Fireworks															--Index 2234*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Fireworks', 										'Action', 'Offense', 	2, 3, 8, '8MA, +1R WILL, MASSIVE DAMAGE, IMPROVED CRITICAL');
/*Lights In Your Eyes												--Index 2235*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Lights In Your Eyes', 							'Action', 'Support', 	1, 3, 6, '6RG, +1G WILL, WILL vs. DEX HEX');
/*Glitter Bomb														--Index 2236*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Glitter Bomb', 									'Potion', 'Offense', 	1, 1, 4, 'DANGEROUS, 4MA, BURST 1');

/*Ice Fan															--Index 2237*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Ice Fan', 										'Action', 'Offense', 	2, 1, -1, '0SW, SWEEP 2, ICE');

/*Frozen Stiff														--Index 2238*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Frozen Stiff', 									'Action', 'Offense', 	2, 3, -1, '0MA, LANCE 4, ICE');

/*Ice King															--Index 2239*/ 		insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Ice King', 										'Action', 'Support', 	2, -1, 3, '3RG, BURST 1, IMMOBILE');
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (862, 2224); --Top Sail Pounce
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (862, 2225); --Sanguine Blade
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (862, 2226); --Epic Duel
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (863, 2229); --Textbook Curse
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (863, 2230); --Let's Discuss Our Plan
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (863, 2231); --Ultra Caffeinated Cramming Potion
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (863, 2232); --Memorized Healing Potion
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (864, 2233); --SparkleBOOM
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (864, 2234); --Fireworks
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (864, 2235); --Lights In Your Eyes
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (864, 2236); --Glitter Bomb
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (865, 2223); --Dun Dun, Nom Nom
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (865, 2224); --Top Sail Pounce
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (865, 2225); --Sanguine Blade
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (865, 2226); --Epic Duel
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (865, 2227); --Run Red
...
insert into KeywordAssignments (EquipmentIndex, KeywordIndex) VALUES (786, 1153); --Mystery Meat
