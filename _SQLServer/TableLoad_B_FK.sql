...
/*Boss Fight, The Guth				--Index kXXX*/ insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'XXX', 'Spawn four Spikers.  Starting with the Player(s), the Consul and the Party alternate placing Spikers in the dungeon until all four are placed.  Spikers may not be placed within three squares of another Spiker or in the first tile.');


/*9 Lives							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', '9 Lives', 'One Use Only.  When a model with 9 Lives is destroyed, immediately roll 1R.  Remove one wound token for each star rolled.  If no stars are rolled, the model is destroyed as normal.');
...
/*Backlash							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 'Backlash', 'If a model targeted by an offensive action and wins the defense roll, the model making the offense roll suffers one wound.  A model may not draw a loot card for destroying a model due to Backlash.');
...
/*Battle Without End				--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Battle Without End', 'If no mini-boss is in play, spawn a mini-boss selected for this game adjacent to target Hero.  The mini-boss immediately suffers three wounds.  Heroes do not draw treasure for destroying this mini-boss.');
...
/*Bewitching Song					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Bewitching Song', 'The Consul may move all Heroes 3 squares, using the rules for Compel.');
...
/*Bully								--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Bully', 'A monster with Bully always targets the Hero with the least wrath with its commands.');

/*Bumper Shell						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Bumper Shell', 'Make a Melee Attack against every Hero in the dungeon, regardless of its location.  Any model which is wounded must discard one equipped equipment card.');


/*Burning Blades					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Burning Blades', 'All elite and minion monsters gain the ability FIRE.');
...
/*Come, My Loves					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Come, My Loves', 'Spawn Spiteful Cherubs anywhere in the dungeon until there are four in play.');

/*Come Hither						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Come Hither', 'All Heroes suffer Compel 2.');

/*Convergence With The Goddess		--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Convergence With The Goddess', 'If the party contains one or more Heroes with Convergence With The Goddess, during the Hero Power-Up phase, the party may discard four loot from the backpack to select a Princess Coin that was not used for this game and spend it to permanently place it on any one Hero''s card, this Princess Coin grants the Hero +1st to defense rolls.');

/*Count of Seven					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Count of Seven', 'When Onryo spawns, begin tracking the number of Hero activations that occur during the Boss Fight.  At the end of the seventh activation, remove one Princess Coin from the backpack.  Then begin the count again.');

/*Counterstrike						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Counterstrike', 'When a model with Counterstrike suffers a wound, it may immediately make a single Melee Attack targeting the model which inflicted the wound, so long as the model is within range.');
...
/*Crystal Shaping					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Crystal Shaping', 'At the start of this model''s activation it may discard one equipment card from the backpack in order to gain one of the following until the start of its next activation, depending on the equpment''s slot:<br>Citrine: +1ac<br>Emerald:  +2mv<br>Ruby:  +1r WILL<br>Sapphire: +1r ARM.');
/*Cursed							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Cursed', 'Equipment with Cursed must be equipped during Power-Up if any Hero has an available slot, and cannot be removed or discarded unless the model is destroyed.');

/*Daemonus							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Daemonus', 'If Daemonus is not in play, spawn Daemonus within six squares of the Midnight Queen.');

/*Dance Party						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Dance Party', 'If another Hero activates after the equipped hero during the same turn, that hero gains:  +2 Movement Points,  +1 Action Point,  +1R DEX,  +1R WILL,  during that activation.');
/*Dark Defender						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Dark Defender', 'The dungeon boss may not be targeted with offensive actions while a model with Dark Defender is in play.');
/*Dark Legion Spawn					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Dark Legion Spawn', 'This elite is also a spawning point, and it may not be placed on the first tile during setup.  After placing it during setup, spawn five Undead Legionaires bonded to it.  When this elite receives the spawn command, roll 1B1R and spawn one Necromutant Solo for each star rolled.  When this elite receives the reinforce command, spawn Undead Legionaires until it has five bonded Undead Legionaires.');


/*Dark Radiance						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Dark Radiance', 'All offense rolls and defense rolls made against a model with Dark Radiance reduce the result by 1ST.');
/*Dark Reflection					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Dark Reflection', 'Boss sightings always affect the tile this Hero is on, in addition to any tiles listed by the Mighty Monster Chart.<br>(Arcade: During Consul Power-Up, look at the top card of the challenge deck. If it has a Trap effect, resolve it immediately, then discard it with no further effect.)');
...
/*Death Curse						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Death Curse', 'Roll 1B.  The Consul may inflict a number of wounds on the Heroes equal to the number of stars rolled.  The wounds must be distributed as evenly as possible.');
...
/*Death Lord						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Death Lord', 'When a model with Death Lord spawns, randomly select a spawning point that was destroyed this game and spawn all gangs listed on it within 3 squares of the model with Death Lord.');
...
/*Demonic Possession				--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Demonic Possession', 'The Consul selects a Hero to be possessed.  The possessed Hero is controlled by the Consul and counts as an 8-Bit monster worth three skull points for all purposes.  It activates on the Consul turn and may not use other Heroes'' potions or equipment.  If the possessed Hero is destroyed it permanently returns to the control of the party.  The Hero''s original controller bring it back into play during the turn''s power-up adjacent to any other Hero without spending a Princess Coin.');
...
/*Difficulty Rating					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Difficulty Rating', 'If the party is unable to beat this boss with the usual number of Princess Coins, they may add X addtional Princess Coins the next time they face this boss.');
/*Difficulty Rating 1				--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Difficulty Rating 1', 'If the party is unable to beat this boss with the usual number of Princess Coins, they may add 1 addtional Princess Coins the next time they face this boss.');
/*Difficulty Rating 2				--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Difficulty Rating 2', 'If the party is unable to beat this boss with the usual number of Princess Coins, they may add 2 addtional Princess Coins the next time they face this boss.');
/*Difficulty Rating 3				--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Difficulty Rating 3', 'If the party is unable to beat this boss with the usual number of Princess Coins, they may add 3 addtional Princess Coins the next time they face this boss.');
...
/*Eternal Flame						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Eternal Flame', 'Enemy models within 2 squares and LOS of a model with Eternal Flame do not remove the Fire status effect at the end of their activation.');
...
/*Feed Me							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 'Feed Me', 'During upkeep, if a monster with Feed Me is suffering any wounds, destroy one minion within two squares of the model and remove one would token.');
...
/*Fire Storm						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Fire Storm', 'All Heroes suffer FIRE.');
...
/*Forest Awakens, The				--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Forest Awakens, The', 'The Consul may spawn up to 4 skull points of monsters from the spawning pool anywhere in the dungeon.');
...
/*Forest's Vengeance The			--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Forest''s Vengeance The', 'This effect does not occur during Boss Sightings.  For the remainder of the game, all monsters except for Mother Noctua gain +1R to all rolls.');
...
/*Furious Bloom						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Furious Bloom', 'This effect only occurs during Boss Sightings.  The Consul may spawn up to 4 skull points of monsters from the spawning pool in each tile affected by the Boss Sighting.  These monsters may spawn anywhere in the tile.');
...
/*Ghostmancer						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Ghostmancer', 'Whenever a model with Ghostmancer inflicts a wound, place a Ghost model adjacent to the wounded model.');

/*Go For The Eyes!					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Go For The Eyes!', 'Spawn 1 Underdead Crow adjacent to each Hero, until there is a maximum of 4 Underdead Crows in play.');


/*Grabby							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Grabby', 'A model that is adjacent to an enemy model with Grabby may not move.');

/*Grave Spawn						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Grave Spawn', 'This Pet may not be brought into play with the Summon Pet action. Instead, if this Pet was selected by a Hero, the Hero may suffer one damage to spawn one Pet Ghost adjacent to any other Hero before that Hero is destroyed.');
/*Grave Visions						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Grave Visions', 'When this model is destroyed, place three red dice on this treasure. This model may discard 1R from the Crimson Watcher when it makes any roll to add 1R to the roll.');
/*Guardian							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Guardian', 'Adjacent Heroes double their Defense bonuses from Princess Coins.');
/*Heroic Mob						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Heroic Mob',	'Friendly models within two squares and Line of Sight gain Mob.');
...
/*Hunger							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Hunger',		'When a model with Hunger rolls a Heart, no other model may benefit from its effect unless the model with Hunger is not suffering any wounds.');
/*Hunter							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Hunter', 'A model with Hunter may reroll a single die when making offensive actions which target spider, gnoll, or orc models.');


/*Hunter's Mark						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Hunter''s Mark', 'Place a crystal token on the closest enemy model.  Friendly models attacking the model with the crystal token gain +1ST STR.  Only one frinedly Mark token may be in play at one time and it may not be removed until the target is destroyed or Mark is used again.');


/*I Know Nothing					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'I Know Nothing', 'A model with this ability may not use the Open Chest action.');
/*Ice								--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Ice',			'A model suffering Ice may not use unique actions.');

/*Illumination						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Illumination', 'Models that target an enemy model within 3 squares of a friendly model with Illumination may reroll a single dice.');
/*Immobile							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Immobile', 	'A model affected by Immobile may not move during its next activation.');
/*Illusionary Double				--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Illusionary Double', 'When a model with Illusionary Double suffers a wound, place one crystal token on its card. It may never have more than one crystal token. When the model is affected by an action that requires a defense roll, it may remove one crystal token to automatically win the roll.');



/*Immune: Fire						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Immune: Fire', 'A model with Immune: Fire ignores and immediately removes all counters and/or the affects of Fire.');
/*Immune: Ice						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Immune: Ice', 'A model with Immune: Ice ignores and immediately removes all counters and/or the affects of Ice.');
/*Immune: Immobile					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Immune: Immobile', 'A model with Immune: Immobile ignores and immediately removes all counters and/or the affects of Immobile.');

/*Immune: Poison					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Immune: Poison', 'A model with Immune: Poison ignores and immediately removes all counters and/or the affects of Poison.');
...
/*Insignificant						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Insignificant', 'If a Hero is on the same dungeon tile as a monster with Insignificant, the monster may be activated in addition to any other monsters that are activated during the Consul Turn.  A model may not draw loot card for destroying a model with Insginificant.');

/*Invader							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Invader', 'When a model with Invader moves adjacent to a Hero immediately remove the model from play and place it on the Hero''s card.  The Invader model may not voluntarily leave the Hero.  The Hero suffers the effects caused by the Invader as long as the Invader model remains on their card.<br><br>Only the affected Hero may target or destroy Invader models on their card.  The Invader is always considered in range.  The Invader cannot be affected by area effects.');


/*Journey, The						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Journey, The', 'Dungeon bosses whose entire base is on the same tile as one or more models with The Journey gain one of the following, depending on which tile this model is on:<br>First Tile: Massive Damage<br>Second Tile: +2R DEX<br>Third Tile: +2R WILL.');
...
/*Knockdown							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Knockdown', 'A model or effect with Knockdown places a Knockdown counter on any model it damages. A model suffering Knockdown may not move or perform any other action until it spends one action point to remove the counter and stand up.'); 

/*Lantern Curse						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Lantern Curse', 'Spawn two Chochin-Obake in any open doorway.');
...
/*Massive Damage					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Massive Damage', 'When an offensive action with Massive Damage inflicts a wound, it inflicts two wounds instead.');
...
/*Mighty							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Mighty', 'A model with Mighty double the bonuses granted by the chart.');
/*Mighty							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Mighty', 'This monster doubles all bonuses gained from the Mighty Monster Chart.');
...
/*Nip the Heels						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Nip the Heels', 'Other friendly monsters within three squares and LoS gain Ravage.');
/*Nom Nom Nom!						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Nom Nom Nom!', 'After a model with Nom Nom Nom! destroys a Naughtie, the model with Nom Nom Nom! Heals 2.');
/*Nom Nom Nom!						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Nom Nom Nom!', 'After a model with Nom Nom Nom! destroys a Naughtie, the model with Nom Nom Nom! Heals 2.  If one or more Naughties are in play, a model with Nom Nom Nom! will ignore all non-Naughtie Heroes when determining the target for a command, unless the only targets in range of an attack are non-Naughtie Heroes.');
...
/*Out of Your Shell					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Out of Your Shell', 'Replace each Turtle Shell model on the dungeon with a Rocktop model from the spawning pool with a skull value of 2 or less.');


/*Overly Prepared					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Overly Prepared', 'At the start of the game draw six treasure cards (any Boo Booties or non-treasures drawn are shuffled back into the deck and a new card is drawn).  Place these cards in a place the party may easily reach them.  Whenever a member of the party is affected by Equip Gadget, they may chooose and equip one of these treasures.  At the beginning of that Hero''s next activation, they msut place the treasure equipped in this way in the discard pile.');
...
/*Poison							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Poison', 'A model suffering Poison reduces its total number of action points by 1, to a minimum of 1.');

/*Poisonous Mist					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Poisonous Mist', 'All Heroes suffer POISON.');
...
/*Rat Pack							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Rat Pack', 'Spawn four Dirty Rats within three squares of the Pauper Prince.');

/*Rat Swarm							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Rat Swarm', 'Spawn four Dirty Rats in any open doorway.');
...
/*Resurrection						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Resurrection', 'When the party spends a Princess Coin, draw two Loot.');
...
/*Rock Up							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default',	'Rock Up', 'All Rocktops gain Immune: Status Effects');
...
/*Run Free, Children!				--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Run Free, Children!', 'Target Naughtie performs up to three moves and one basic attack action controlled by the Consul.  If there are no Naughties in play, any Hero may be chosen instead.');
...
/*Salty								--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 'Salty', 'A model with Salty gains +1ST STR for each tentacles token on the target.');
/*Salty								--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Salty', 'A model with Salty gains +1R STR for each tentacles token on the target.');

/*Scavenger							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Scavenger', 'If a monster with Scavenger discards equipment from a Hero, place the equipment next to the monster.  The monster gains +1ST STR for each equipment discarded in this way.');
/*Scavenger							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Scavenger', 'The Consul selects up to two loot from the discard pile or backpack and equips them to Onibaba.');

/*Scent								--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Scent', 'Models with Scent ignore Stealth');

/*Scrap Metal						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Scrap Metal', 'All Heroes must randomly discard an equipped loot card, if able.');

/*Scuttle							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Scuttle', 'The party draws one less loot for destroying a model with Scuttle.');
...
/*Sense Weakness					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Sense Weakness', 'A model with Sense Weakness gains +1G to offensive actions targeting a model with one or more status effects.');
/*Shake Down						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Shake Down', 'Enemy Heroes with the Immobile status effect that are on the same tile as a model with Shake Down count as rolling zero stars for the purpose of the Yoink ability whenever they fail a defense roll.');

/*Shake It Off						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Shake If Off', 'When this Hero spends a Princess Coin to return to play, it shapeshifts into its original form.');

/*Shame								--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Shame', 'After a model with Shame! is destroyed, the model that destroyed it suffers Push 6.');
...
/*Skittish							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 'Skittish', 'When a monster with Skittish receives a Move command, it moves away from the closest Hero as far as it is able.');

/*Skulls of the Fallen				--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Skulls of the Fallen', 'Spawn six Ghostflames:  two adjacent to each SPAWNPOINT square on the first, second, and third tiles.  Whenever a Hero is destroyed, spawn one Ghostflame adjacent to any SPAWNPOINT (up to a maximum of six Ghostflames in play).');

/*Sky Blackens, The					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Sky Blackens, The', 'Spawn 2 Underdead Crows within 4 squares of The Thresher.');


/*Slayer							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Slayer', 'A model with Slayer may reroll a single die when making offensive actions which target dragon, kobold, or drake models.');

/*Slow								--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Slow', 'A model suffering Slow halves its movement points, rounding up.');
...
/*Soul Echo							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Soul Echo', 'The first time this Hero succeeds with an offensive action against a SUPER monster, it must discard this treasure and add one Princess Coin to the backpack.');

/*Soul Jar							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Soul Jar', 'Place three potion tokens on Elrik.  Elrik gains potions when winning offense rolls AND defense rolls.  For the remainder of the game, after making a roll, Elrik may spend one potion token to reroll one die.  Only a single die per roll may be rerolled.');
...
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Cold Eggs (Spawning Point)<br>2x Frostbyte Wyrmling<br>2x Frostbyte Whelp<br>2x Frostbyte Hatchling');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Cold Eggs (Spawning Point)<br>2x Frostbyte Wyrmling<br>2x Frostbyte Whelp<br>2x Frostbyte Hatchling<br><br>Cards:<br>1x Hoarfang''s Brood');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Corrupted Harvest (Spawning Point)<br>1x Crow Eater<br>2x Harvest Socks<br>4x Harvest Goons<br>2x Rotten Pumpkins');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Corrupted Harvest (Spawning Point)<br>1x Crow Eater<br>2x Harvest Socks<br>4x Harvest Goons<br>2x Rotten Pumpkins<br><br>Cards:<br>1x Out of the Cornfield<br>1x Reap The Harvest<br>1x Rotten Pumpkin');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Cursed Barrow (Spawning Point)<br>1x Black Hand<br>4x Draugr');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Cursed Barrow (Spawning Point)<br>1x Black Hand<br>4x Draugr<br><br>Cards:<br>1x Order of the Black Hand<br>1x Drauger Berserker');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Cursed Barrow (Spawning Point)<br>1x Black Hand<br>5x Draugr');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Cursed Barrow (Spawning Point)<br>1x Black Hand<br>5x Draugr<br><br>Cards:<br>1x Order of the Black Hand<br>1x Drauger Berserker');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '2x Cursed Hollow (Spawning Point)<br>1x Bad Seed<br>1x Wrath Sprout (Shapeshift)<br>2x Gloom Wisp<br>2x Spoiled Turnip<br>6x Rotten Cabbage');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '2x Cursed Hollow (Spawning Point)<br>1x Bad Seed<br>1x Wrath Sprout (Shapeshift)<br>2x Gloom Wisp<br>2x Spoiled Turnip<br>6x Rotten Cabbage<br><br>Cards:<br>1x Rotten Seeds<br>1x Vengeful Compost<br>1x Gloom Wisps<br>1x Spoiled Turnips');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Cursed Knight (Spawning Point)<br>1x Grobbit Deathlord<br>2x Skull Squawk<br>4x Moorland Militia');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Cursed Knight (Spawning Point)<br>1x Grobbit Deathlord<br>2x Skull Squawk<br>4x Moorland Militia<br><br>Cards:<br>1x Deathlord Militia<br>1x Skull Riders');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Egg Clutch (Spawning Point)<br>2x Wyrmling<br>2x Whelp<br>2x Hatchling');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Egg Clutch (Spawning Point)<br>2x Wyrmling<br>2x Whelp<br>2x Hatchling<br><br>Cards:<br>1x Dragonborn');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '2x Fire Flow Hollow (Spawning Point)<br>1x Magma Seed<br>1x Volcanic Sprout (Shapeshift)<br>2x Flame Wisp<br>2x Spicy Turnip<br>6x Broiled Mook');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '2x Fire Flow Hollow (Spawning Point)<br>1x Magma Seed<br>1x Volcanic Sprout (Shapeshift)<br>2x Flame Wisp<br>2x Spicy Turnip<br>6x Broiled Mook<br><br>Cards:<br>1x Sprouting Magma<br>1x Volcanic Growth<br>1x Flame Wisps<br>1x Spicy Turnips');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Forgotten Stone (Spawning Point)<br>1x Midnight Mutineer<br>2x Blackblade Corsair<br>3x Corsair Arbalist');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Forgotten Stone (Spawning Point)<br>1x Midnight Mutineer<br>2x Blackblade Corsair<br>3x Corsair Arbalist<br><br>Cards:<br>1x Boarding Party<br>1x Corsair Arbalist');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '2x Frozen Warrens (Spawning Point)<br>1x Frozen Priest<br>2x Frostscales<br>2x Snowball Chucker<br>3x Blockhead<br>3x Ice Pick');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '2x Frozen Warrens (Spawning Point)<br>1x Frozen Priest<br>2x Frostscales<br>2x Snowball Chucker<br>3x Blockhead<br>3x Ice Pick<br><br>Cards:<br>1x Cult of Frozen Spires<br>1x Frostfang Horde<br>1x Snowball Fight');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Howler Stone (Spawning Point)<br>1x Pack Leader<br>1x Ranger<br>2x Hunter<br>2x Warrior');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Howler Stone (Spawning Point)<br>1x Pack Leader<br>1x Ranger<br>2x Hunter<br>2x Warrior<br><br>Cards:<br>1x The Grassy Gnolls<br>1x Gnoll With The Punches');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '2x Kobold Warrens (Spawning Point)<br>1x Dragon Priest<br>2x Ironscales<br>2x Flingers<br>3x Knuckleheads<br>3x Gougers');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '2x Kobold Warrens (Spawning Point)<br>1x Dragon Priest<br>2x Ironscales<br>2x Flingers<br>3x Knuckleheads<br>3x Gougers<br><br>Cards:<br>1x Scale Wall<br>1x Dragon Devotee<br>1x Sneaks');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Maleficent Idol (Spawning Point)<br>1x Master of Chains<br>2x Heartbound<br>4x Devout of Araphel');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Maleficent Idol (Spawning Point)<br>1x Master of Chains<br>2x Heartbound<br>4x Devout of Araphel<br><br>Cards:<br>1x Araphel''s Heart<br>1x Cult of Araphel');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Maleficent Idol (Spawning Point)<br>1x Master of Chains<br>2x Heartbound<br>4x Devout of Araphel');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Maleficent Idol (Spawning Point)<br>1x Master of Chains<br>2x Heartbound<br>4x Devout of Araphel<br><br>Cards:<br>1x Cult of Araphel<br>1x Heartbound');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Nether Clutch (Spawning Point)<br>2x Nether Wyrmling<br>2x Nether Whelp<br>2x Nether Hatchling');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Nether Clutch (Spawning Point)<br>2x Nether Wyrmling<br>2x Nether Whelp<br>2x Nether Hatchling<br><br>Cards:<br>1x Demon Drakes');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Pinching Palace (Spawning Point)<br>1x Lord of the Crabs<br>3x Big Claw<br>3x Carapace Crawler');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Pinching Palace (Spawning Point)<br>1x Lord of the Crabs<br>3x Big Claw<br>3x Carapace Crawler<br><br>Cards:<br>1x Pinching Party<br>1x Carapace Crawler');
...
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Shadow Tower (Spawning Point)<br>1x Tower Stalker<br>2x Tower Blackblade<br>3x Tower Arbalist');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Shadow Tower (Spawning Point)<br>1x Tower Stalker<br>2x Tower Blackblade<br>3x Tower Arbalist<br><br>Cards:<br>1x Shadow Guard<br>1x Tower Arbalist');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '2x Shadow Warrens (Spawning Point)<br>1x Shadow Priest<br>2x Shadowscales<br>2x Dark Lobber<br>3x Dimwit<br>3x Skewer');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '2x Shadow Warrens (Spawning Point)<br>1x Shadow Priest<br>2x Shadowscales<br>2x Dark Lobber<br>3x Dimwit<br>3x Skewer<br><br>Cards:<br>1x Cult of the Dark<br>1x Shadow Brigade<br>1x Squirrely Slingers');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Nepharite Warlord (Spawning Point)<br>4x Undead Legionaires<br>4x Necromutants');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Nepharite Warlord (Spawning Point)<br>4x Undead Legionaires<br>4x Necromutants<br><br>Cards:<br>1x Dark Legion Horde<br>1x Necromutant');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Skull Stone (Spawning Point)<br>2x Neck Splitters<br>2x Face Beaters<br>2x Knuckle Smashers');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Skull Stone (Spawning Point)<br>2x Neck Splitters<br>2x Face Beaters<br>2x Knuckle Smashers<br><br>Cards:<br>1x Smasher Mob<br>1x Splitter Mob');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Spawn of Servitude (Spawning Point)<br>1x Head Nurse<br>2x Potion Mistress<br>4x Wretch');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Spawn of Servitude (Spawning Point)<br>1x Head Nurse<br>2x Potion Mistress<br>4x Wretch<br><br>Cards:<br>1x The Night Shift<br>1x A Ratchet of Nurses');

/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spawning Pool', '1x Spider Nest (Spawning Point)<br>1x Spider Seeker<br>3x Crawler<br>3x Shadow Spinner');
/*Spawning Pool						--Index kXXX*/	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spawning Pool', '1x Spider Nest (Spawning Point)<br>1x Spider Seeker<br>3x Crawler<br>3x Shadow Spinner<br><br>Cards:<br>1x Crawler Cluster<br>1x Spinner Spindle');
...
/*Spiteful Whispers					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Spiteful Whispers', 'Heroes suffer -1ST WILL for each model with Spiteful Whispers adjacent to them.');
/*Spiteful Whispers					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 	'Spiteful Whispers', 'A model with a Spiteful Cherub on its card sufers -1st WILL to all WILL rolls.  The Hero must also roll 1G at the end of every Consul turn and apply one of the below status effects, depending on the roll:<br>0ST: Bane<br>1ST: Hex<br>2ST: Ice<br>3ST: Poison<br>4ST: Immobile');
/*Splinters							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Splinters', 'When a model with Splinters achieves a Critical Success, it suffers one damage.');
/*Spooky Spooky!					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Spooky Spooky!', 'At the end of this model’s activation, it may cause target adjacent Hero to Push: 3.');


/*Soporific							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Soporific',	'When a model with Soporific is destroyed, the model that destroyed it suffers SLOW');
...
/*Stealth Aura						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Stealth Aura', 'Monsters with RUBYAFFINITY that are within two squares of a model with Stealth Aura gain Stealth.');
...
/*Tribute To Myself					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Tribute To Myself', 'When this model wins a defensive roll, it may heal itself using hearts as if it were an offensive roll.');
...
/*Unapologetically Naughty			--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Unapologetically Naughty', 'After a model with Unapologetically Naughty deals three wounds during a single activation, it shapeshifts back into its original form.');
/*Uncanny Awareness					--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Uncanny Awareness', 'Models with Uncanny Awareness ignore Stealth.');

/*Undead Horde						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Undead Horde', 'Spawn 4 Kodeads within four squares of Nightsong the Eternal');

/*Unpredictable						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Unpredictable', 'At the end of its activation, a model with Unpredictable must roll 1R.  If it rolls no stars, the model must move three squares towards the closest other Hero and make a basic melee attack against it.');
...
/*Yoink!							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'Yoink!', 'When a model with Yoink! achieves a critical success, its target must discard one equipped loot card at random, if able.');
/*Yoink!							--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 'Yoink!', 'When a monster with Yoink! attacks a Hero and the Hero rolls stars for defense, the Hero must discard one equipped loot card at random, if able.');

/*Yoink								--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Arcade', 'Yoink', 'When a monster with Yoink attacks a Hero and the Hero rolls zero stars for defense, the Hero must discard one equipped loot card at random, if able.');

/*Your Goddess Has Forsaken You		--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Default', 'Your Goddess Has Forsaken You', 'All enemy Heroes discard all spent Princess Coins from their cards.  All enemy Heroes without Princess Coins to discard suffer one wound.');


/*You're Alone						--Index kXXX*/ 	insert into Keywords (KeywordVersion, PlayMode, Name, KeywordDescription) VALUES ('2.0', 'Explore', 'You''re Alone', 'A model with You''re Alone gains +2B to offensive actions that are targeting a model that has no other models friendly to it within two squares.');
...
/*Absolute Destruction												--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Absolute Destruction', 'Action', 'Offense', 0, 1, -1, 'Sweep 2, +2ST STR');
/*Ambush Predator													--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Ambush Predator', 'Action', 'Offense', 1, 1, 5, '1SW, Pounce');
...
/*Azogar															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Azogar', 'Action', 'Offense', 0, 1, -1, 'Wave 2');
...
/*Booming Bombards													--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Booming Bombards', 'Action', 'Offense', 2, 4, 10, '10MI, +2G DEX, Burst 3.');
...
/*Breath of Disease													--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Breath of Disease', 'Action', 'Offense', 1, 3, -1, '0MA, Sweep 2, POISON');
...
/*Broken Will														--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Broken Will', 'Action', 'Support', 1, 3, -1, 'Wave 2, WILL vs WILL, ICE');

/*Brutal Onslaught													--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Brutal Onslaught', 'Action', 'Offense', 1, 1, -1, '0SW, Lance 6, Charge');

/*BURN!																--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'BURN!', 'Action', 'Support', 1, 1, -1, 'Wave 3, FIRE');
/*Burning Maze														--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Burning Maze', 'Action', 'Offense', 2, 3, -1, 'Wave 2, WILL vs WILL, FIRE');
...
/*Chew on This!														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Chew on This!', 'Action', 'Support', 1, -1, 3, 'AUGMENT, Throw 3');

/*Chew Toy															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Chew Toy', 'Action', 'Offense', 0, 1, 3, '+2ST STR, Massive Damage');

/*Chill of the Grave												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Chill of the Grave', 'Action', 'Offense', 2, 3, -1, 'Wave 3, ICE');
/*Chill of the Grave												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Chill of the Grave', 'Action', 'Offense', 0, 1, -1, 'Wave 4, ICE');
...
/*Cloud of Straw													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Cloud of Straw', 'Action', 'Offense', 0, 1, -1, '0MA, Wave 1, HEX');
...
/*Cold Fury															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Cold Fury', 'Action', 'Support', 1, -1, 0, 'AUGMENT, +1R STR');
...
/*Concussion Shell													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Concussion Shell', 'Action', 'Offense', 1, -1, 10, '10MI, Massive Damage.  This model must discard a crystal shell token from a square it occupies in order to take this action.');
...
/*Creeping Growth													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Creeping Growth', 'Action', 'Offense', 1, 3, -1, 'This action affects all Heroes in play.  This action may only be taken once per turn.');

/*Crippling Miasma													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Crippling Miasma', 'Action', 'Offense', 2, 3, -1, '0MA, Wave 2, BANE');
...
/*Cull The Weak														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Cull The Weak', 'Action', 'Offense', 1, 1, 3, '3SW, Massive Damage, this attack may only target models suffering BANE.');
/*Cull the Weak														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Cull the Weak', 'Action', 'Offense', 0, 1, -1, 'Wave 3, Massive Damage, only models suffering Bane are affected by this attack.');

/*Cunning Blade														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Cunning Blade', 'Action', 'Offense', 0, 1, -1, 'Wave 2');
/*Cunning Lies														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Cunning Lies', 'Action', 'Support', 0, -1, 6, 'Pull 3');

/*Curse of Coin, The												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Curse of Coin, The', 'Action', 'Offense', 0, 1, 6, 'The target suffers one additional wound for each PRINCESSCOIN spent this game.');

/*Curse of Gold, The												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Curse of Gold, The', 'Action', 'Offense', 0, 1, 6, 'If the target has two equipped items suffers BANE, if it has more than two equipped items it suffers BANE and FIRE.');

/*Curse of The Angry Monkey											--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Curse of The Angry Monkey', 'Action', 'Offense', 1, 3, 6, '6MA, HEX');

/*Cursed Cleaver													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Cursed Cleaver', 'Action', 'Offense', 0, 1, -1, 'Lance 4, BANE, HEX');


/*Cursed Vision														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Cursed Vision', 'Action', 'Support', 1, 3, -1, 'Wave 3, WILL vs WILL, BANE, IMMOBILE');
...
/*Death Drain														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Death Drain', 'Action', 'Offense', 3, 3, -1, 'DANGEROUS, 0MA, Wave 3.  Elrik removes one wound token for each wound inflicted by Death Drain.');
...
/*Death Pact														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Death Pact', 'Action', 'Support', 0, -1, 3, 'Place a Death Pact token on the target.  When a model with a Death Pact token inflicts a wound it also suffers a wound.  The token is removed when Shinigami or the model is destroyed.');
...
/*Deeproot Rage														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Deeproot Rage', 'Action', 'Offense', 2, 3, -1, '0MA, Wave 4, POISON');
...
/*Demon Flame														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Demon Flame', 'Action', 'Offense', 0, 1, -1, 'Wave 3, FIRE, ICE');


/*Demonic Challenge													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Demonic Challenge', 'Action', 'Support', 0, -1, -1, 'Place the Hero with the least Wrath adjacent to this model.');
...
/*Demonic Rampage													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Demonic Rampage', 'Action', 'Offense', 2, 1, 3, '3SW, Massive Damage, Improved Critical');
/*Demonic Rush														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Demonic Rush', 'Action', 'Offense', 0, 1, 3, 'Massive Damage');
...
/*Dirty Strike														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Dirty Strike', 'Action', 'Offense', 0, 1, 2, 'Model''s may not use equipment that increase ARM when making a defense roll against Dirty Strike.');
...
/*Dragon Hoard														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Dragon Hoard', 'Action', 'Support', 3, -1, -1, 'AUGMENT, Draw one loot card; choose to equip it in the same manner as a Hero, or discard it.');
...
/*Easy Mark															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Easy Mark', 'Action', 'Support', 1, 3, 6, 'RANGE6, WILL v WILL, IMMOBILE');
...
/*Empower Darkness													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Empower Darkness', 'Action', 'Support', 1, -1, -1, 'AUGMENT, Aura 3, Dark Radiance');
...
/*Extra Powder														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Extra Powder', 'Action', 'Offense', 2, 4, 6, '6MI, Massive Damage, Brutal Strike');
/*Extra Powder														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Extra Powder', 'Action', 'Offense', 0, -1, 0, 'Massive Damage');
...
/*Feed, My Children													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Feed, My Children', 'Action', 'Support', 1, -1, -1, 'All other monsters may take a basic offensive action.  This action may only be taken once per turn.');
...
/*Feed on Essence													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Feed on Essence', 'Action', 'Support', 1, -1, -1, 'Heal 1 for each model suffering POISON within three squares and LOS.  This action may only be taken once per activation.');
/*Feed on Essence													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Feed on Essence', 'Action', 'Support', 0, -1, 1, 'Heal 1 for each model suffering POISON within three squares and LOS.');
...
/*Final Day															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Final Day', 'Action', 'Offense', 2, 3, 1, '1MA, +1G WILL, Massive Damage.  This attack ignores Princess Coins.');
...
/*Flurry of Blades													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Flurry of Blades', 'Action', 'Offense', 0, 1, -1, 'Wave 3');


/*For Mistress!														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'For Mistress!', 'Action', 'Offense', 0, 1, 3, 'Massive Damage');

/*Fortification														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Fortification', 'Action', 'Support', 0, -1, -1, 'AUGMENT, Aura 3, +1ST ARM');
/*Foul Weather														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Foul Weather', 'Action', 'Support', 0, -1, -1, 'AUGMENT, Aura 8, Stealth');

/*Foxy																--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Foxy', 'Action', 'Support', 0, -1, -1, 'AUGMENT, Aura 3, Stealth');
...
/*Fragmentation Shell												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Fragmentation Shell', 'Action', 'Offense', 0, 1, -1, 'Burst 2, KNOCKDOWN');
...
/*Frogger															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Frogger', 'Action', 'Offense', 0, 1, 5, 'Pounce');
...
/*Gather, My Children												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Gather, My Children', 'Action', 'Support', 1, -1, -1, 'AUGMENT, At the end of this model''s activation it spawns four Yowlings due to its Ferocious Hoot ability instead of two.  This action may only be taken once per turn.');


/*Get Out!															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Get Out!', 'Action', 'Offense', 2, 1, -1, 'SW, Wave 1, Push 3');
...
/*Ghastly Vigor														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Ghastly Vigor', 'Action', 'Support', 0, -1, -1, 'AUGMENT, Aura 3, All Undead gain +1ST STR');
/*Ghoul Blade														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Ghoul Blade', 'Action', 'Offense', 2, 1, -1, 'SW, Sweep 3, BANE, HEX');
/*Ghoul Blade														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Ghoul Blade', 'Action', 'Offense', 0, 1, -1, 'SW, Wave 3, BANE, HEX');

/*Go For The Eyes!													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Go For The Eyes!', 'Action', 'Support', 1, -1, -1, 'Once per turn.  All Spiteful Cherubs in play may immediately make a 1SW attack.');
/*Go For The Eyes!													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Go For The Eyes!', 'Action', 'Support', 0, -1, -1, 'All Spiteful Cherubs perform the Move command.');

/*Goblin Toss														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Goblin Toss', 'Action', 'Offense', 1, 1, 6, '6SW, Burst 2, to take this action, this model must destroy a Goblin Creep within two squares before rolling.');


/*Grabbing Stick													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Grabbing Stick', 'Action', 'Offense', 2, 1, 4, '4SW, Compel 4, Massive Damage');
/*Grabbing Stick													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Grabbing Stick', 'Action', 'Offense', 0, 1, 4, 'Pull 4');
/*Grasping Vines													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Grasping Vines', 'Action', 'Offense', 0, 1, 3, 'Pull 3');

/*Gunpowder Burst													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Gunpowder Burst', 'Action', 'Offense', 2, 1, -1, '0SW, Wave 3');
/*Gunpowder Savant													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Gunpowder Savant', 'Action', 'Support', 1, -1, -1, 'AUGMENT, Until the end of the next Hero turn all Tora Yajiri in play gain Improved Critical and all Tora Oni and Tora Kunoichi in play increase the range of attacks generated by the Volatile ability to Wave 2.');

/*Hail of Fire														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Hail of fire', 'Action', 'Offense', 0, 1, 6, '6SW, The STR of this attack is equal to the number of Undead Legionaires bonded to this elite.');

/*Hammer Toss														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Hammer Toss', 'Action', 'Offense', 1, 1, -6, '6SW, +1G STR, Massive Damage.  To take this action, Lord Vulcanis must first discard a Relic Item.');
...
/*Homunculus														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Homunculus', 'Action', 'Offense', 1, 1, 2, '2SW, If Homunculus inflicts a wound, one friendly Witch may Heal 1.');
...
/*Illsionary Maze													--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Illsionary Maze', 'Action', 'Support', 1, -1, -1, 'DANGEROUS, Wave 2, Compel 3');
...
/*Into The Bag														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Into The Bag', 'Action', 'Offense', 2, 3, 1, '1MA, +1R WILL, IMMOBILE, HEX');
...
/*Juggernaut														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Juggernaut', 'Action', 'Offense', 1, 1, -1, '0SW, Lance 4, Charge, this action affects models regardless of LOS.');
...
/*Leaping Strike													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Leaping Strike', 'Action', 'Offense', 2, 1, -1, '0SW, +1R STR, Lance 6, Charge');
...
/*Lovestruck														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Lovestruck', 'Action', 'Offense', 2, 3, 6, '6RANGE, WILL vs. WILL.  Compel 4.  On a critical sucess, spawn up to two Spiteful Cherubs adjacent to the target after moving it.');
...
/*Make Mischief														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Make Mischief', 'Action', 'Support', 1, -1, 10, '10RANGE, target Naughtie performs three moves and one basic attack action, controlled by the Consul.  Make Mischief may not target the same Naughtie more than once per turn.');
...
/*Monkey's Paw														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Monkey''s Paw', 'Action', 'Offense', 1, 3, 3, 'BANE');
...
/*Mountain Flute													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Mountain Flute', 'Action', 'Support', 1, 3, 6, 'RANGE6, WILL vs WILL, Push 6, SLOW');
...
/*Mountain Disapproves, The											--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Mountain Disapproves, The', 'Action', 'Offense', 1, 3, 6, '6MA, ICE');
...
/*Out Of My Way!													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Out Of My Way!', 'Action', 'Offense', 2, 1, -1, '0SW, Sweep 3, KNOCKDOWN');
...
/*Pacify The Way													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Pacify The Way', 'Action', 'Offense', 1, 4, 4, '4RANGE, DEX vs. DEX, on a critical discard one random equipment from the target.');
...
/*Pipe Puff															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Pipe Puff', 'Action', 'Offense', 1, 4, -1, '0MI, Lance 6, POISON');
/*Pipe Puff															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Pipe Puff', 'Action', 'Offense', 0, 1, -1, '0SW, Lance 6');

/*Poison Blast														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Poison Blast', 'Action', 'Offense', 2, 1, -1, '0SW, Lance 6');

/*Pound The Ice														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Pound The Ice', 'Action', 'Offense', 2, 1, -1, '0SW, Cross 3, Improved Critical');

/*Powder Bomb														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Powder Bomb', 'Action', 'Offense', 2, 4, 4, '4MI, +1B DEX, Burst 1');

/*Power Nap															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Power Nap', 'Action', 'Support', 1, -1, 0, 'AUGMENT.  Heal 1. This action may only be taken once per turn.');
...
/*Protect															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Protect', 'Action', 'Support', 1, -1, -1, 'DANGEROUS, Place target Witch adjacent to Daemonus, no matter its location in the dungeon.');

/*Pumpkin Toss														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Pumpkin Toss', 'Action', 'Support', 1, -1, 1, 'AUGMENT, Throw 4');
...
/*Raging Flame														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Raging Flame', 'Action', 'Support', 0, -1, -1, 'DANGEROUS, Wave 2, Models in the area that are currently suffering FIRE suffer one wound.');
...
/*Rampagin Fists													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Rampagin Fists', 'Action', 'Offense', 0, 1, -1, 'Wave 1, +1ST STR');

/*Ravenform															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Ravenform', 'Action', 'Support', 0, -1, -1, 'Place this model adjacent to the furthest spawning point from it.');
/*Raven Feather														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Raven Feather', 'Action', 'Support', 0, -1, -1, 'AUGMENT, Aura 6, Fly.');

/*Rear Up															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Rear Up', 'Action', 'Offense', 2, 1, -1, '0SW, Wave 2, KNOCKDOWN');
/*Rear Up															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Rear Up', 'Action', 'Offense', 0, 1, -1, 'Wave 4, KNOCKDOWN');

/*Relentless Onslaught												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Relentless Onslaught', 'Action', 'Offense', 0, -1, 0, 'Massive Damage');

/*Reload!															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Reload!', 'Action', 'Support', 0, -1, -1, 'Remove all wounds from all Gunpowder Gala gangs in play.');

/*Renewed Vigor														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Renewed Vigor', 'Action', 'Support', 0, -1, -1, 'AUGMENT, Wave 2, Compel 2');
/*Reposition														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Reposition', 'Action', 'Offense', 0, 1, 6, 'Retreat');

/*Rex Smash															--Index kXXX*/ 	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Rex Smash', 'Action', 'Offense', 0, 1, 3, '+1ST STR, Massive Damage');

/*Rift Spreads, The													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Rift Spreads, The', 'Action', 'Offense', 1, 3, -1, '0MA, Wave 3, BANE');
/*Rift Spreads, The													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Rift Spreads, The', 'Action', 'Offense', 0, 1, -1, 'Wave 4, BANE');

/*Run 'em Down														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Run ''em Down', 'Action', 'Support', 0, -1, -1, 'This model moves four squares towards the closest Hero.  It will move into the same square as the Hero if able.  Any Heroes whose square this model moves over during this move suffer one wound and KNOCKDOWN and must be placed into an adjacent square.');

/*Sand Storm														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Sand Storm', 'Action', 'Support', 0, -1, -1, 'AUGMENT, Aura 3, enemy models that end their activation within the aura suffer 2 wounds.');
...
/*Scent of Death													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Scent of Death', 'Action', 'Offense', 1, 3, 3, '3MA, if this action inflicts a wound, spawn two Kodeads within 2 squares of the target.  This action may only be taken once per turn.');


/*Scuttling Menace													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Scuttling Menace', 'Action', 'Support', 0, -1, 2, 'Spawn one Big Claw within 2 squares of this elite.');
...
/*Seasoning															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Seasoning', 'Action', 'Support', 0, -1, -1, 'AUGMENT, this model may reroll all rolls it makes due to Pig Feed this turn.');
...
/*Shell Shock														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Shell Shock', 'Action', 'Offense', 2, 1, -1, '0SW, Lance 10, KNOCKDOWN, Charge');
...
/*Sieze Prey														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Sieze Prey', 'Action', 'Support', 0, 1, -1, 'The closest Hero (or the Hero with the most wrath if multiple Heroes are equally close) suffers Push 6.  Then place this model adjacent to the Hero that was pushed.');



/*Silk Noose														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Silk Noose', 'Action', 'Offense', 1, 4, 8, 'Pull 6.');
...
/*Spider to the Fly													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Spider to the Fly', 'Action', 'Support', 1, -1, 4, '4RANGE, Place up to 3 skull points of spiders from anywhere in the dungeon, adjacent to target Hero.');

/*Spin Around Real Fast												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Spin Around Real Fast', 'Action', 'Offense', 0, 1, -1, 'Wave 3, KNOCKDOWN');

/*Spin Webs															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Spin Webs', 'Action', 'Offense', 1, 3, -1, '0MA, Wave 1, this offensive action gains Massive Damage against models suffering POISON.');
...
/*Stay Out Of This, Fool											--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Stay Out Of This, Fool', 'Action', 'Support', 0, 3, 10, '10RANGE, WILL vs. WILL, Compel 6, KNOCKDOWN, SLOW May not target the Champion.');
...
/*Stinging Wind														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Stinging Wind', 'Action', 'Offense', 1, 3, -1, '0MA, Wave 2, ICE');
...
/*Summon the Horde													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Summon the Horde', 'Action', 'Support', 0, -1, -1, 'The gang with an elite closest to Gothmog Reinforces.');
/*Summon Minions													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Summon Minions', 'Action', 'Support', 2, -1, 3, 'AUGMENT.  Spawn two skull points of 8-Bit monsters within three squares of Randy, then Randy suffers two wounds.');
/*Summon Minions													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Summon Minions', 'Action', 'Support', 0, -1, -1, 'AUGMENT, select a gang available in the spawning pool and spawn it within three squares of Randy.');

/*Sweeping Spear													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Sweeping Spear', 'Action', 'Offense', 0, 1, -1, 'Wave 4');

/*Swirling Claws													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Swirling Claws', 'Action', 'Offense', 2, 4, 2, '+1R DEX, after completing this attack, this model may move up to 3 squares.');

/*Tail Sweep														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Tail Sweep', 'Action', 'Offense', 0, 1, -1, 'Sweep 2, KNOCKDOWN.');

/*Tears of Anger													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Default', 'Tears of Anger', 'Potion', 'Support', 1, -1, 0, 'AUGMENT, Discard one equipment card from the backpack in order for this Hero to make up to two basic offensive actions.');


/*A Tetsubo for Every Face											--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'A Tetsubo for Every Face', 'Action', 'Offense', 2, 1, 3, '3SW, Burst 2');
/*A Tetsubo for Every Face											--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'A Tetsubo for Every Face', 'Action', 'Offense', 0, 1, -1, 'Wave 4');

/*Tether															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Tether', 'Action', 'Support', 0, -1, 10, 'RANGE10, Pull 4');

/*This is Junk														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'This is Junk', 'Action', 'Offense', 1, 1, 6, '6SW, Massive Damage, Discard one equipped Loot to take this action.');

/*Tora Tora Tora!													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Tora Tora Tora!', 'Action', 'Support', 1, -1, -1, 'If there is a Fight command this turn, it is considered an Epic Fight command by all monsters on this tile.');

/*Toxicity															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Toxicity', 'Action', 'Support', 1, -1, -1, 'AUGMENT, Aura 3, All spiders gain POISON.');

/*Trample															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Trample', 'Action', 'Offense', 0, 1, -1, 'Wave 1, KNOCKDOWN.');


/*Travel The Way													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Travel The Way', 'Action', 'Support', 1, -1, 0, 'AUGMENT, place this model to any Waystone in play.');
/*Travel The Way													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Travel The Way', 'Action', 'Support', 0, -1, 0, 'Place this model within 3 squares of the Waystone with the lowest Health on the tile with the greatest number of Heroes.');

/*Turtle Tosser														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Turtle Tosser', 'Action', 'Offense', 1, 1, 1, 'DANGEROUS, Throw 6, KNOCKDOWN');

/*Undertow															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Undertow', 'Action', 'Support', 0, -1, -1, 'All Heroes with at least one tentacles token must choose to suffer either IMMOBILE, or two wounds.');

/*Unfortunate Accident												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Unfortunate Accident', 'Action', 'Support', 1, 3, 8, '8RANGE, WILL vs WILL, Target model makes a single basic attack of Onryo''s choice against itself.');
...
/*Unnatural Dark													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Unnatural Dark', 'Action', 'Support', 0, -1, -1, 'AUGMENT, Aura 3, Stealth');

/*Vent Steam														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Vent Steam', 'Action', 'Offense', 0, 1, -1, 'Wave 3, +1ST STR');
...
/*Void Lightning													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Void Lightning', 'Action', 'Offense', 0, 1, -1, 'Wave 3, HEX');

/*Wait In Shadow													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Wait In Shadow', 'Action', 'Support', 1, -1, 4, '4RANGE, Place a crystal token in target square.  Friendly models adjacent to the token gain Predator.  An adjacent model may spend tow movement points to remove the token.');
/*Wait In Shadow													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Wait In Shadow', 'Action', 'Support', 0, -1, 4, 'All monsters on this tile gain Predator.');
...
/*Wildfire															--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Arcade', 'Wildfire', 'Action', 'Offense', 1, 3, -1, '0MA, Lance 6, FIRE');
...
/*With Your Last Breath												--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'With Your Last Breath', 'Action', 'Support', 1, -1, -1, 'AUGMENT, Aura 8, Fury');
/*Wraith Walk														--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Wraith Walk', 'Action', 'Offense', 1, -1, -1, 'AUGMENT, Aura 4, An undead model which begins its activation within the area, gains Ghost during its activation.');

/*Yamazaru's Tail													--Index abXXX*/	insert into Abilities (AbilityVersion, PlayMode, Name, AbilityResource, AbilityType, AbilityCost, AttributeIndex, AbilityRange, AbilityDescription) VALUES ('2.0', 'Explore', 'Yamazaru''s Tail', 'Action', 'Offense', 2, 4, -1, '0MI, Wave 3, KNOCKDOWN');
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (83, 541); --Secret Ingredient
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (83, 666); --Waldmeister Syrup
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (83, 1, 1); --Strength
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (84, 480); --Pixie Dust
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (85, 295); --Dwarven Curse
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (85, 379); --Hero's Balm
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (86, 682); --Wizard Wings
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (87, 181); --Benevolence
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (88, 657); --Valor
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (89, 680); --Wisdom
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (90, 681); --Wisdom
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (91, 268); --Deep Mad Tentattack
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (92, 524); --Ringside Canteen
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (93, 621); --Take a Hint
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (93, 373); --Heart Attack Herbs
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (94, 241); --Confetti Sprinkle
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (94, 177); --Baked Goods
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (95, 455); --Ninja Pop
...
--Miserable Toad --CardIndex 182	--CharacterIndex 96	--ExploreCharacterIndex 96
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Miserable Toad', 
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (96, 598); --Sticky Tongue
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (96, 4, 2); --Dexterity
...
--Mistmourn Shaman --CardIndex 183	--CharacterIndex 97	--ExploreCharacterIndex 97
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Mistmourn Shaman', 
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (97, 587); --Spirit Burn
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (97, 644); --Troll Heart
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (97, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (97, 3, 6); --Will
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (97, 2); --Armor

--Nether Assassin --CardIndex 184	--CharacterIndex 98	--ExploreCharacterIndex 98
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Nether Assassin', 
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (98, 380); --Hex Bolt
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (98, 449); --Nether Ash
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (98, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (98, 4, 6); --Dexterity
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (99, 609); --Super Shuriken
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (99, 321); --Fizzy Beverage
...
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (99, 4); --Dexterity
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (100, 342); --Frosty Soda Bomb
...
--Nyan-Nyan  --CardIndex 187	--CharacterIndex 101	--ExploreCharacterIndex 101
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Nyan-Nyan', 
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (101, 242); --Coolmint Kitty Bomb
...
--One Shot  --CardIndex 188	--CharacterIndex 102	--ExploreCharacterIndex 102
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'One Shot', 
...
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (102, 4, 8); --Dexterity
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (102, 2); --Armor

--Outcast Succubus  --CardIndex 189	--CharacterIndex 103	--ExploreCharacterIndex 103
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Outcast Succubus', 
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (103, 157); --Alluring Perfume
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (103, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (103, 3, 6); --Will
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (103, 2); --Armor
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (103, 4); --Dexterity

--Princess Emerald (beta) --CardIndex 190	--CharacterIndex 103	--ExploreCharacterIndex 103
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
...
--Princess Emerald --CardIndex 191	--CharacterIndex 104	--ExploreCharacterIndex 104
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Princess Emerald', 
...
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (104, 4, 8); --Dexterity
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (104, 2); --Armor

--Princess Malya --CardIndex 192	--CharacterIndex 105	--ExploreCharacterIndex 105
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Princess Malya', 
...
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (105, 1, 2); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (105, 2); --Armor
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (105, 4); --Dexterity

--Princess Ruby --CardIndex 193	--CharacterIndex 106	--ExploreCharacterIndex 106
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Princess Ruby', 
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (106, 431); --Maiden's Token
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (106, 430); --Maiden's Kiss
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (106, 294); --Dress-up Draught
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (106, 3, 6); --Will
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (106, 2); --Armor
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (106, 4); --Dexterity

--Questing Knight (beta)--CardIndex 194	--CharacterIndex 107	--ExploreCharacterIndex 107
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (107, 426); --Magic Armor
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (144, 1); --Citrine
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (147, 473); --Berserk
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (147, 554); --Immune: Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (147, 587); --Pile-On
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (147, 614); --Sweeping Mace
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (147, 405); --Introspection
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (147, 'Masculine', 'Large', 'Chimera', 6, 3, '2B 2R', '2ST1R', '3B', '2B', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (147, 1, 1); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (147, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (147, '', 'Super', 4);

--Bashful Boris --CardIndex 235	--CharacterIndex 148	--ExploreCharacterIndex 148
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Bashful_Boris.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
'When human, Boris was a large and gentle lad.  During The Forgotten King''s rebellion Boris lept at the chance to prove himself to his noble lord, only to quickly turn timid and fearful when faced with the reality of war.');
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (148, 554); --Immune: Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (148, 587); --Pile-On
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (148, 613); --Sweeping Mace
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (148, 296); --Earthshaker
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (148, 'Masculine', 'Large', 'Chimera', 6, 3, '3B 2R', '3B', '1B1R', '2B', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (148, 1, 1); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (148, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (148, '', 'Super', 4);

--Captain R --CardIndex 236	--CharacterIndex 149	--ExploreCharacterIndex 149
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Captain_R.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (149, 544); --Hoard
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (149, 329); --Flintlock
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (149, 415); --Kraken
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (149, 684); --'X' Marks the Spot
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (149, 'Masculine', 'Small', 'Undead Skeleton Pirate', 6, 3, '1B 2R', '2B 1R', '1B1R', '1B1R', 5, 0);
...
--Chaos Kitty --CardIndex 237	--CharacterIndex 150	--ExploreCharacterIndex 150
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Chaos_Kitty.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
'');
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (150, 456); --9 Lives
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (150, 473); --Berserk
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (150, 623); --Teeth & Fur
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (150, 226); --Chaos Fuzz
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (150, 175); --Bad Kitty
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (150, 'Feminine', 'Small', 'Freyjan', 7, 3, '2B 2R', '2B', '3B', '1ST2R', 5, 0);
...
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (150, 4); --Dexterity
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (150, '', 'Super', 4);

--Death Spectre --CardIndex 238	--CharacterIndex 151	--ExploreCharacterIndex 151
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Death_Spectre.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (151, 554); --Immune: Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (151, 522); --Ghost
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (151, 418); --Lifesap
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (151, 576); --Soul Scythe
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (151, 583); --Spectre
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (151, 'Either', 'Large', 'Undead', 1, 3, '1B', '2R', '2ST1G', '3B', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (151, 3, 2); --Will
...
--Deranged Alchemist --CardIndex 239	--CharacterIndex 152	--ExploreCharacterIndex 152
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Deranged_Alchemist.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (152, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (152, 457); --Alchemy
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (152, 592); --Potion Master
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (152, 661); --Vile Concoction
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (152, 413); --Kobold's Tears
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (152, 236); --Coagulated Mixture
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (152, 'Feminine', 'Small', 'Elf', 7, 3, '2B', '3B1R', '2B2R', '2B', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (152, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (152, 3, 6); --Will
...
--Glimmerwing	--CardIndex 240	--CharacterIndex 153	--ExploreCharacterIndex 153
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Glimmerwing.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (153, 550); --Immune: Bane
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (153, 552); --Immune: Hex
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (153, 518); --Fly
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (153, 201); --Breath of Dream
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (153, 660); --Verdant Maze
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (153, 311); --Fae Curse
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (153, 'Feminine', 'Large', 'Faerie Dragon', 8, 3, '2R', '2ST1R', '3R', '3B', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (153, 1, 2); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (153, 3, 6); --Will
...
--Gruesome George --CardIndex 241	--CharacterIndex 154	--ExploreCharacterIndex 154
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Gruesome_George.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (154, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (154, 580); --Mob
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (154, 635); --Static Charge
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (154, 648); --Tough
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (154, 596); --Static Discharge
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (154, 207); --Brilliant
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (154, 298); --Electric Jolt
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (154, 'Masculine', 'Large', 'Undead Zombie', 6, 3, '2B', '2B', '1B', '1B', 6, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (154, 1, 2); --Strength
...
--Herald of Vulcanis	--CardIndex 242	--CharacterIndex 155	--ExploreCharacterIndex 155
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Herald_of_Vulcanis.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (155, 4); --Sapphire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (155, 551); --Immune: Fire
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (155, 325); --Flaming Javelin
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (155, 550); --Shield Bash
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (155, 472); --Phalanx
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (155, 'Masculine', 'Small', 'Dark Celestian', 7, 3, '1ST3R', '2R', '1B1R', '2B1R', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (155, 1, 2); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (155, 4, 6); --Dexterity
...
--Iron Golem --CardIndex 243	--CharacterIndex 156	--ExploreCharacterIndex 156
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Iron_Golem.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
'');
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (156, 492); --Crystal Heart
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (156, 551); --Shield Wall
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (156, 616); --Sword Toss
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (156, 368); --Hard Hit
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (156, 'Neither', 'Large', 'Construct', 6, 3, '2ST2R', '3R', '1B', '1B', 6, 0);
...
--Jack Scarecrow --CardIndex 244	--CharacterIndex 157	--ExploreCharacterIndex 157
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Jack_Scarecrow.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (157, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (157, 517); --Flammable
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (157, 370); --Harvest Scythe
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (157, 213); --Bumper Crop
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (157, 533); --Run Birdy
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (157, 'Neither', 'Small', 'Construct', 6, 3, '2B2R', '3B', '1ST2R', '1B', 6, 0);
...
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (157, 3); --Will
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (157, '', 'Super', 4);

--Kaelly the Nether Strider --CardIndex 245	--CharacterIndex 158	--ExploreCharacterIndex 158
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Kaelly_The_Nether_Strider.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (158, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (158, 589); --Poison
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (158, 641); --Surefoot
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (158, 637); --Stealth
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (158, 380); --Hex Bolt
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (158, 254); --Dark Aura
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (158, 'Feminine', 'Small', 'Elf', 7, 3, '1B1R', '3B', '3B', '3R', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (158, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (158, 4, 6); --Dexterity
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (158, 2); --Armor
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (158, 4); --Dexterity
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (158, '', 'Super', 4);

--Kasaro To --CardIndex 246	--CharacterIndex 159	--ExploreCharacterIndex 159
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Kasaro_To.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (159, 4); --Sapphire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (159, 648); --Tough
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (159, 535); --Serpent Coil
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (159, 685); --Zealotry
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (159, 569); --Snare
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (159, 'Masculine', 'Large', 'Oni', 6, 3, '1ST2R', '2R', '3B', '2B', 5, 0);
...
--Kunoichi Candy --CardIndex 247	--CharacterIndex 160	--ExploreCharacterIndex 160
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Kunoichi_Candy.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (160, 624); --Sidestep
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (160, 637); --Stealth
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (160, 466); --Pachi-Pachi-Pachi
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (160, 453); --Ninja Assassin
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (160, 279); --Distracting Costume
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (160, 'Feminine', 'Small', 'Human', 6, 3, '2B', '2B', '2B2R', '2R', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (160, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (160, 3, 6); --Will
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (160, '', 'Super', 1);

--Ninja Cola --CardIndex 248	--CharacterIndex 161	--ExploreCharacterIndex 161
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Ninja_Cola.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into Characters (CardIndex) VALUES (244);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (161, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (161, 624); --Sidestep
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (161, 626); --Small
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (161, 332); --Flying Fur
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (161, 610); --Super Shuriken
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (161, 343); --Frosty Soda Bomb
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (161, 'Masculine', 'Small', 'Kitsune', 7, 3, '3B', '2B', '1B1R', '2B2R', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (161, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (161, 4, 8); --Dexterity
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (161, 2); --Armor
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (161, 4); --Dexterity
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (161, '', 'Super', 1);

--Oni --CardIndex 249	--CharacterIndex 162	--ExploreCharacterIndex 162
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Oni.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (162, 1); --Citrine
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (162, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (162, 503); --Elemental Affinity
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (162, 274); --Disaster
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (162, 270); --Devour
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (162, 267); --Deceive
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (162, 'Masculine', 'Large', 'Oni', 6, 3, '3R', '2R', '3B', '2B', 6, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (162, 1, 2); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (162, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (162, '', 'Super', 4);

--Rex --CardIndex 250	--CharacterIndex 163	--ExploreCharacterIndex 163
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Rex.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (163, 580); --Mob
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (163, 627); --Thwomp
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (163, 520); --Rex Cuddle
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (163, 522); --Rex Smash
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (163, 'Masculine', 'Large', 'Kobold Ogre', 5, 3, '2R2B', '2R', '1B', '2B', 6, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (163, 1, 2); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (163, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (163, '', 'Super', 4);

--Rock Gut --CardIndex 251	--CharacterIndex 164	--ExploreCharacterIndex 164
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Rock_Gut.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (164, 4); --Sapphire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (164, 512); --Fire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (164, 551); --Immune: Fire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (164, 648); --Tough
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (164, 215); --Burning Bile
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (164, 314); --Feast
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (164, 'Masculine', 'Large', 'Troll', 6, 3, '1ST3B1R', '2B2R', '1B', '2B', 5, 0);
...
--Salt --CardIndex 252	--CharacterIndex 165	--ExploreCharacterIndex 165
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Salt.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (165, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (165, 518); --Fly
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (165, 608); --Summer
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (165, 679); --Winter
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (165, 232); --Circle of Salt
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (165, 'Either', 'Large', 'Faerie', 6, 3, '2ST1R', '2ST1R', '3B', '2B', 6, 0);
...
--Ser Sharpclaw --CardIndex 253	--CharacterIndex 166	--ExploreCharacterIndex 166
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Ser_Sharpclaw.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (166, 641); --Surefoot
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (166, 609); --Savage
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (166, 461); --Onslaught
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (166, 229); --Chomp! Crunch!
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (166, 'Masculine', 'Large', 'Kobold', 8, 3, '1ST3R', '1ST2R', '1B1R', '1B1R', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (166, 1, 3); --Strength
...
--Ser Snapjaw --CardIndex 254	--CharacterIndex 167	--ExploreCharacterIndex 167
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Ser_Snapjaw.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (167, 554); --Immune: Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (167, 580); --Mob
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (167, 185); --Blazing Blade
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (167, 383); --Hightower
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (167, 514); --Rally Cry
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (167, 'Masculine', 'Small', 'Kobold', 7, 3, '1B1R', '3R', '1B1R', '1B1R', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (167, 1, 3); --Strength
...
--Shadow-Mode Candy --CardIndex 255	--CharacterIndex 168	--ExploreCharacterIndex 168
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Shadow_Mode_Candy.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (168, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (168, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (168, 495); --Dark Radiance
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (168, 256); --Dark Howling
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (168, 450); --Nether Soul
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (168, 543); --Shadow
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (168, 'Feminine', 'Small', 'Nether Shadow', 6, 3, '4B', '3B', '1B1R', '2R', 5, 0);
...
--Succubus Vandella --CardIndex 256 --CharacterIndex 169 --ExploreCharacterIndex 169 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/MiniBosses/Succubus_Vandella.xhtml', 
'MiniBoss', 'FK', 'FK Core Set', 'Explore',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (169, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (169, 518); --Fly
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (169, 157); --Alluring
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (169, 204); --Breathtaking Kiss
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (169, 238); --Come Hither
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (169, 'Feminine', 'Small', 'Demon', 7, 3, '1B 1R', '2B', '3B 1R', '3R', 5, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (169, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (169, 3, 6); --Will
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (169, 2); --Armor
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (169, 4); --Dexterity
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (170, 4); --Sapphire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (170, 555); --Immune: Poison
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (170, 648); --Tough
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (170, 651); --Virulent
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (170, 657); --Vulnerable: Fire
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (170, 262); --Decay
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (170, 464); --Overgrowth
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (170, 656); --Uproot
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (170, 'Neither', 'Large', 'Treant Kodama', 6, 3, '1ST 2R', '1ST 2R', '2R', '1B', 6, 0);
...
--Trent --CardIndex 258 --CharacterIndex 171 --ExploreCharacterIndex 171
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (171, 4); --Sapphire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (171, 555); --Immune: Poison
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (171, 648); --Tough
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (171, 651); --Virulent
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (171, 263); --Decay
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (171, 687); --Overgrowth
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (171, 656); --Uproot
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (171, 'Neither', 'Large', 'Treant Kodama', 6, 3, '1ST 2R', '1ST 2R', '2R', '1B', 6, 0);
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (172, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (172, 518); --Fly
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (172, 524); --Ghostmancer
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (172, 563); --Kitty Claws
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (172, 593); --Potion Stash
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (172, 495); --Pumpkin Charge
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (172, 211); --Bubble & Boil
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (172, 252); --Curses!
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (172, 'Feminine', 'Large', 'Witch', 7, 4, '2R', '2ST 1R', '2R 1G', '3B', 8, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (172, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (172, 1, 8); --Will
...
--The Forgotten King --CardIndex 260 --CharacterIndex 173 --ExploreCharacterIndex 173
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'The Forgotten King',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (173, 547); --Hubris
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (173, 641); --Surefoot
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (173, 602); --Stranglethorn
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (173, 503); --Primal Roar
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (173, 336); --Forestwalker
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (173, 'Masculine', 'Large', 'Chimera', 6, 4, '2R 1G', '2B 1G', '3B 2R', '3B', 8, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (173, 1, 2); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (173, 1, 6); --Will
...
--Goro --CardIndex 261 --CharacterIndex 174 --ExploreCharacterIndex 174
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Goro',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (174, 554); --Immune: Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (174, 550); --Immune: Bane
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (174, 580); --Mob
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (174, 507); --Feed Me
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (174, 518); --Fly
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (174, 676); --Wind Spirit
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (174, 269); --Devour
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (174, 183); --Biting Gale
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (174, 435); --Meddlesome Giri
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (174, 'Masculine', 'Large', 'Faerie', 4, 4, '1ST 3B 1G', '3R', '3R', '3B', 8, 0);
...
--King Starfire --CardIndex 262 --CharacterIndex 175 --ExploreCharacterIndex 175
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'King Starfire',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (175, 644); --Tail Sweep
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (175, 401); --Inferno
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (175, 555); --Shooting Star
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (175, 290); --Dragon Horn
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (175, 619); --Tail Sweep
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (175, 'Masculine', 'Large', 'Dragon', 6, 4, '2ST 2R 1G', '2R 1G', '2R', '2R', 8, 0);
...
--Nocturne --CardIndex 263 --CharacterIndex 176 --ExploreCharacterIndex 176
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Nocturne',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (176, 473); --Berserk
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (176, 260); --Dead Cold
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (176, 313); --Feast
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (176, 'Masculine', 'Large', 'Shapeshift', 8, 4, '2ST 2B 2R', '2B 2R', '1ST 2R', '3B', 6, 0);
...
--Ragin' Roxor --CardIndex 264 --CharacterIndex 177 --ExploreCharacterIndex 177
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Ragin'' Roxor',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (177, 618); --Shapeshift: Rockin' Roxor
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (177, 663); --Volcano
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (177, 443); --Molten Steel
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (177, 'Masculine', 'Large', 'Shapeshift', 6, 4, '2B 2R 1G', '2B 2R', '2B 1R', '2B', 8, 0);
...
--Rockin' Roxor --CardIndex 265 --CharacterIndex 178 --ExploreCharacterIndex 178
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Rockin'' Roxor',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (178, 4); --Sapphire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (178, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (178, 617); --Shapeshift: Ragin' Roxor
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (178, 441); --Minion Toss
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (178, 224); --Cave In
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (178, 'Masculine', 'Large', 'Elemental', 6, 4, '2ST 2R', '2ST 2R 2G', '2B 1R', '1B', 8, 0);
...
--Starfire --CardIndex 266 --CharacterIndex 179 --ExploreCharacterIndex 179
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Starfire',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (179, 4); --Citrine
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (179, 557); --Immune: Fire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (179, 617); --Hoard
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (179, 617); --Tail Sweep
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (179, 441); --Inferno
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (179, 224); --Dragon Hoard
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (179, 'Masculine', 'Large', 'Dragon', 8, 4, '1ST 2R 1G', '1B 1R 1G', '2R', '2R', 8, 0);
...
--Von Drakk --CardIndex 267 --CharacterIndex 180 --ExploreCharacterIndex 180
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Von Drakk',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (180, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (180, 475); --Blood Drinker
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (180, 616); --Shapeshift: Nocturne
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (180, 164); --Army of Bone
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (180, 352); --Ghastly Vigor
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (180, 625); --Thriller
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (180, 397); --Hypnotic Gaze
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (180, 'Masculine', 'Small', 'Undead Vampire', 8, 4, '2ST 4B', '2B', '1ST 2R', '3R', 6, 0);
...
--FK --Warband Monsters
--Bramble Knight
--Bramble Knight --CardIndex 268 --CharacterIndex 181 --ExploreCharacterIndex 181
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Bramble Knight',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (181, 478); --Bramble Growth
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (181, 660); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (181, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 3, 0);
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (182, 625); --Slow
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (182, 'Either', 'Small', 'Chimera', 6, 1, '3B', '1ST', '2B', '1B 1R', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (182, 'Minion', '8 Bit', 4);
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (183, 641); --Surefoot
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (183, 339); --Frogger
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (183, 612); --Supremely Skilled Shrieking Squawk Strike
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (183, 'Either', 'Small', 'Chimera', 8, 2, '2B 1R', '2ST', '2B', '1B 1R', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (183, 'Minion', '8 Bit', 2);
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (184, 571); --Massive Damage
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (184, 'Either', 'Large', 'Chimera', 6, 2, '3B 1R', '1B 1R', '1B', '3B', 3, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (184, 'Minion', '16 Bit', 3);

--Claw Shrine
--Claw Shrine --CardIndex 272 --CharacterIndex 185 --ExploreCharacterIndex 185
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Claw Shrine',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (185, 1); --Citrine
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (185, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (185, 478); --Dragon Blessing
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (185, 662); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (185, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 4, 0);
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (186, 637); --Stealth
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (186, 468); --Backstabber
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (186, 169); --Assassinate
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (186, 'Either', 'Small', 'Kobold', 7, 2, '2R', '0ST', '1B1R', '2R', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (186, 'Elite', '16 Bit', 2);
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (187, 580); --Mob
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (187, 469); --Packmaster
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (187, 446); --Monster Tamer
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (187, 'Either', 'Small', 'Kobold', 7, 1, '3B', '0ST', '1B1R', '1B1R', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (187, 'Elite', '8 Bit', 1);
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (188, 564); --Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (188, 586); --Pile-On
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (188, 188); --Blood Scent
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (188, 'Either', 'Small', 'Drake', 7, 1, '3B', '1ST', '2B', '3B', 1, 0);
...
--Egg Clutch
--Egg Clutch --CardIndex 276 --CharacterIndex 189 --ExploreCharacterIndex 189
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Egg Clutch',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (189, 535); --Hatchery
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (189, 664); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (189, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 3, 0);
...
--Hatchlings --CardIndex 277 --CharacterIndex 190 --ExploreCharacterIndex 190
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Hatchlings',
...
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (190, 'Either', 'Small', 'Drake', 6, 2, '3B', '0ST', '2B', '3B', 2, 0);
...
--Whelp --CardIndex 278 --CharacterIndex 191 --ExploreCharacterIndex 191
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Whelp',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (191, 564); --Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (191, 586); --Pile-On
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (191, 'Either', 'Small', 'Drake', 6, 1, '2B1R', '1ST', '3B', '3B', 1, 0);
...
--Wyrmling --CardIndex 279 --CharacterIndex 192 --ExploreCharacterIndex 192
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Wyrmling',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (192, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (192, 518); --Fly
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (192, 586); --Pile-On
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (192, 322); --Flame Burst
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (192, 281); --Dive Bomb
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (192, 'Either', 'Small', 'Drake', 6, 2, '2B1R', '1ST', '3B', '3B', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (192, 1, 2); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (192, 4, 6); --Dexterity
...
--Elemental Shrine --CardIndex 280 --CharacterIndex 193 --ExploreCharacterIndex 193
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Elemental Shrine',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (193, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (193, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (193, 503); --Elemental Affinity
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (193, 543); --Hidden
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (193, 637); --Stealth
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (193, 666); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (193, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 4, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (193, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (193, '', 'Start', 0);

--Chunin --CardIndex 281 --CharacterIndex 194 --ExploreCharacterIndex 194
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Chunin',
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (194, 322); --Precision Strike
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (194, 281); --Elemental Master
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (194, 'Masculine', 'Small', 'Ninja', 6, 3, '2B1R', '3B', '3B', '3B', 3, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (194, 'Elite', '16 Bit', 2);

--Kaiken --CardIndex 282 --CharacterIndex 195 --ExploreCharacterIndex 195
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Kaiken',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (195, 1); --Citrine
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (195, 637); --Stealth
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (195, 174); --Back Strike
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (195, 'Masculine', 'Small', 'Ninja', 6, 1, '3B', '1ST', '2B', '3B', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (195, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (195, 4, 3); --Dexterity
...
--Kunoichi --CardIndex 283 --CharacterIndex 196 --ExploreCharacterIndex 196
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Kunoichi',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (196, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (196, 637); --Stealth
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (196, 674); --Wind in the Forest
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (196, 'Feminine', 'Small', 'Ninja', 8, 1, '3B', '0ST', '1B1R', '2R', 1, 0);
...
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (196, 4); --Dexterity
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (196, 'Minion', '8 Bit', 1);

--Madoushi --CardIndex 284 --CharacterIndex 197 --ExploreCharacterIndex 197
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Madoushi',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (197, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (197, 637); --Stealth
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (197, 482); --Poisoned Weapons
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (197, 677); --Wind Walk
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (197, 'Masculine', 'Small', 'Ninja', 6, 2, '2B', '1ST', '2R', '3B', 2, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (197, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (197, 3, 6); --Magic
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (197, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (197, 'Minion', '8 Bit', 2);

--Yajiri --CardIndex 285 --CharacterIndex 198 --ExploreCharacterIndex 198
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Yajiri',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (198, 652); --Wind of Blades
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (198, 'Masculine', 'Small', 'Ninja', 6, 1, '2B', '0ST', '2B', '3B', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (198, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (198, 4, 6); --Dexterity
...
--Fungal Growth --CardIndex 286 --CharacterIndex 199 --ExploreCharacterIndex 199
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Fungal Growth',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (199, 630); --Soporific Cloud
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (199, 668); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (199, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 3, 0);
...
--Kinoshroom --CardIndex 287 --CharacterIndex 200 --ExploreCharacterIndex 200
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Kinoshroom',
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (200, 200); --Bounce
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (200, 'Neither', 'Small', 'Kinoko', 6, 1, '3B', '0ST', '1B', '2B', 1, 0);
...
--Okoshroom --CardIndex 288 --CharacterIndex 201 --ExploreCharacterIndex 201
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Okoshroom',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (201, 629); --Soporific
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (201, 634); --Spongy
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (201, 669); --Whirling Shitake
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (201, 624); --Tempermental Toadstool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (201, 'Neither', 'Large', 'Kinoko', 6, 3, '3B', '1ST2B', '1B', '2B', 4, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (201, 1, 2); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (201, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (201, 'Elite', '16 Bit', 2);

--Truffle Pig --CardIndex 289 --CharacterIndex 202 --ExploreCharacterIndex 202
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Truffle Pig',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (202, 1); --Citrine
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (202, 652); --Tusker
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (202, 347); --Funky Fungus Sniffer
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (202, 'Either', 'Small', 'Pig', 7, 2, '2R', '1ST', '3B', '2B', 2, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (202, 'Elite', '8 Bit', 2);

--Grabby House --CardIndex 290 --CharacterIndex 203 --ExploreCharacterIndex 203
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Grabby House',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (203, 4); --Sapphire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (203, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (203, 530); --Grabby Hands
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (203, 670); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (203, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 4, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (203, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (203, '', 'Start', 0);

--Prowler --CardIndex 291 --CharacterIndex 204 --ExploreCharacterIndex 204
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Prowler',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (204, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (204, 528); --Grabby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (204, 580); --Mob
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (204, 637); --Stealth
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (204, 322); --Homunculus
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (204, 'Either', 'Small', 'Undead Zombie', 8, 2, '3B', '1ST', '1B', '3B', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (204, 'Minion', '8 Bit', 1);

--Pudge --CardIndex 292 --CharacterIndex 205 --ExploreCharacterIndex 205
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Pudge',
...
--Shamble Priest --CardIndex 293 --CharacterIndex 206 --ExploreCharacterIndex 206
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Shamble Priest',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (206, 3); --Ruby
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (206, 475); --Pin Cushion
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (206, 665); --Wakey-Wakey
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (206, 201); --Brain Food
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (206, 'Masculine', 'Small', 'Witch', 6, 2, '2B', '3B', '2R', '1B1R', 3, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (206, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (206, 3, 6); --Magic
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (206, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (206, 'Elite', '16 Bit', 2);

--Swampie --CardIndex 294 --CharacterIndex 207 --ExploreCharacterIndex 207
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Swampie',
...
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (207, 'Either', 'Small', 'Undead Zombie', 5, 1, '2B', '1ST', '1B', '1B', 1, 0);
...
--Kobold Warrens --CardIndex 295 --CharacterIndex 208 --ExploreCharacterIndex 208
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Kobold Warrens',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (208, 1); --Citrine
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (208, 518); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (208, 586); --Mob Mentality
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (208, 672); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (208, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 4, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (208, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (208, '', 'Start', 0);

--Dragon Priest --CardIndex 296 --CharacterIndex 209 --ExploreCharacterIndex 209
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Dragon Priest',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (209, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (209, 580); --Mob
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (209, 292); --Dragon Rage
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (209, 546); --Shadow Breath
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (209, 'Either', 'Small', 'Kobold', 7, 3, '2B', '1B1R', '2R', '1B1R', 3, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (209, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (209, 3, 6); --Magic
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (209, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (209, 'Elite', '16 Bit', 2);

--Flinger --CardIndex 297 --CharacterIndex 210 --ExploreCharacterIndex 210
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Flinger',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (210, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (210, 580); --Mob
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (210, 392); --Hot Pot
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (210, 567); --Smoke Pot
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (210, 'Either', 'Small', 'Kobold', 7, 1, '2B', '0ST', '2B', '1B1R', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (210, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (210, 4, 6); --Dexterity
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (210, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (210, 'Elite', '8 Bit', 1);

--Gouger --CardIndex 298 --CharacterIndex 211 --ExploreCharacterIndex 211
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Gouger',
...
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (211, 'Either', 'Small', 'Kobold', 7, 1, '3B', '0ST', '2B', '1B1R', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (211, 1, 2); --Strength
...
--Ironscale --CardIndex 299 --CharacterIndex 212 --ExploreCharacterIndex 212
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Ironscale',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (212, 4); --Amethyst
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (212, 580); --Mob
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (212, 537); --Scalewall
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (212, 'Either', 'Small', 'Kobold', 7, 2, '2R', '2ST', '2B', '1B1R', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (212, 'Elite', '8 Bit', 2);

--Knucklehead --CardIndex 300 --CharacterIndex 213 --ExploreCharacterIndex 213
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Knucklehead',
...
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (213, 'Either', 'Small', 'Kobold', 7, 1, '3B', '1ST', '2B', '1B1R', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (213, 1, 1); --Strength
...
--Lava Whirl --CardIndex 301 --CharacterIndex 214 --ExploreCharacterIndex 214
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Lava Whirl',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (214, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (214, 513); --Fire Aura
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (214, 674); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (214, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 3, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (214, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (214, '', 'Start', 0);

--Blaze Beetle --CardIndex 302 --CharacterIndex 215 --ExploreCharacterIndex 215
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Blaze Beetle',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (215, 481); --Burrow
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (215, 349); --Furnace Vent
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (215, 218); --Burning Chitin
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (215, 'Either', 'Large', 'Elemental Bug', 6, 3, '2B1R', '1ST1R', '2B', '2B', 3, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (215, 1, 3); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (215, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (215, 'Elite', '16 Bit', 2);

--Burning Gel --CardIndex 303 --CharacterIndex 216 --ExploreCharacterIndex 216
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Burning Gel',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (216, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (216, 512); --Fire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (216, 551); --Immune: Fire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (216, 632); --Splurt
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (216, 590); --Splort
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (216, 'Either', 'Large', 'Elemental Slime', 6, 2, '3B', '0ST', '3B', '1B1R', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (216, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (216, 3, 6); --Magic
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (216, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (216, 'Minion', '8 Bit', 2);

--Ember Hound --CardIndex 304 --CharacterIndex 217 --ExploreCharacterIndex 217
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Ember Hound',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (217, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (217, 551); --Immune: Fire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (217, 637); --Stealth
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (217, 556); --Sickening Smoke
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (217, 168); --Ash Cloud
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (217, 'Either', 'Small', 'Elemental Wolf', 8, 1, '2R', '1ST', '2B', '3B', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (217, 'Elite', '8 Bit', 1);

--Fire Gel --CardIndex 305 --CharacterIndex 218 --ExploreCharacterIndex 218
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Fire Gel',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (218, 559); --Insignificant
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (218, 568); --Little Splurt
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (218, 626); --Small
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (218, 'Either', 'Small', 'Elemental Slime', 6, 1, '3B', '0ST', '3B', '1B1R', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (218, 1, 2); --Strength
...
--Old Growth Hollow --CardIndex 306 --CharacterIndex 219 --ExploreCharacterIndex 219
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Old Growth Hollow',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (219, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (219, 590); --Poison Aura
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (219, 676); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (219, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 4, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (219, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (219, '', 'Start', 0);

--King Sprout --CardIndex 307 --CharacterIndex 220 --ExploreCharacterIndex 220
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'King Sprout',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (220, 508); --Feed Me
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (220, 516); --Fixed Form
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (220, 361); --Grasping Vines
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (220, 528); --Rootdown
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (220, 'Neither', 'Large', 'Shapeshift', 0, 3, '2B2R', '2R', '3B', '1B', 4, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (220, 1, 4); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (220, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (220, 'Shapeshift', '16 Bit', 3);

--Mook --CardIndex 308 --CharacterIndex 221 --ExploreCharacterIndex 221
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Mook',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (221, 589); --Poison
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (221, 555); --Immune: Poison
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (221, 651); --Virulent
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (221, 'Neither', 'Small', 'Kodama', 6, 1, '3B', '1ST', '3B', '2B', 1, 0);
...
--Sprout --CardIndex 309 --CharacterIndex 222 --ExploreCharacterIndex 222
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Sprout',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (222, 2); --Sapphire
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (222, 519); --Forced Shift
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (222, 619); --Shapeshift: King Sprout
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (222, 515); --Rampant Growth
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (222, 'Neither', 'Small', 'Kodama', 6, 1, '1B', '2R', '3B', '1B1R', 2, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (222, 'Minion', '8 Bit', 1);

--Turniphead --CardIndex 310 --CharacterIndex 223 --ExploreCharacterIndex 223
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Turniphead',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (223, 2); --Emerald
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (223, 407); --It's Medicinal
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (223, 'Neither', 'Small', 'Kodama', 6, 1, '2B', '0ST', '3B', '2B1R', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (223, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (223, 4, 6); --Dexterity
...
--Wisp --CardIndex 311 --CharacterIndex 224 --ExploreCharacterIndex 224
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Wisp',
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (224, 322); --Pollen Dream
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (224, 'Neither', 'Small', 'Kodama', 6, 2, '1B', '1ST', '2B1R', '3B', 2, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (224, 3, 6); --Magic
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (224, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (224, 'Elite', '8 Bit', 2);

--Pumpkin Patch --CardIndex 312 --CharacterIndex 225 --ExploreCharacterIndex 225
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Pumpkin Patch',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (225, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (225, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (225, 526); --Gloom Aura
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (225, 678); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (225, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 3, 0);
...
--Crypt Spider --CardIndex 313 --CharacterIndex 226 --ExploreCharacterIndex 226
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Crypt Spider',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (226, 1); --Citrine
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (226, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (226, 589); --Poison
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (226, 641); --Surefoot
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (226, 305); --Enervating Bite
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (226, 559); --Silk Spinner
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (226, 'Either', 'Large', 'Spider', 6, 3, '2R', '3B', '2B', '2R', 3, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (226, 1, 2); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (226, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (226, 'Elite', '16 Bit', 2);

--Curse Coven Witch --CardIndex 314 --CharacterIndex 227 --ExploreCharacterIndex 227
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Curse Coven Witch',
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (227, 554); --Shocking Bolt
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (227, 639); --Transmogrify
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (227, 'Feminine', 'Small', 'Witch', 8, 2, '1B', '0ST', '3B', '3B', 2, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (227, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (227, 3, 6); --Magic
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (227, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (227, 'Elite', '8 Bit', 1);

--Skullbat --CardIndex 315 --CharacterIndex 228 --ExploreCharacterIndex 228
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Skullbat',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (228, 3); --Ruby
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (228, 518); --Fly
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (228, 559); --Insignificant
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (228, 283); --Doom
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (228, 'Either', 'Small', 'Undead Bat', 6, 1, '1B', '0ST', '1B1R', '2R', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (228, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (228, 1, 6); --Magic
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (228, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (228, 'Minion', '8 Bit', 1);

--Rock Pile --CardIndex 316 --CharacterIndex 229 --ExploreCharacterIndex 229
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Rock Pile',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (229, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (229, 606); --Rock Aura
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (229, 680); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (229, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 4, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (229, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (229, '', 'Start', 0);

--Bombardier --CardIndex 317 --CharacterIndex 230 --ExploreCharacterIndex 230
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Bombardier',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (230, 554); --Immune: Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (230, 556); --Immune: Slow
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (230, 623); --Shell
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (230, 222); --Cannon
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (230, 646); --Turtle Cannon
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (230, 'Either', 'Small', 'Rocktop', 5, 1, '1B', '1ST', '3B', '1B', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (230, 'Elite', '8 Bit', 1);

--Crusher v1 --CardIndex 318 --CharacterIndex 231 --ExploreCharacterIndex 231
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Crusher v1',
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (231, 632); --Thwack
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (231, 649); --Turtle Tremor
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (232, 659); --Bulldozer
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (232, 632); --Thwack
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (232, 649); --Turtle Tremor
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (232, 675); --No Hiding
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (232, 'Either', 'Large', 'Rocktop', 5, 3, '2B1R', '1ST2B', '3B', '1B', 4, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (232, 'Elite', '16 Bit', 2);

--Roller --CardIndex 320 --CharacterIndex 233 --ExploreCharacterIndex 233
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Roller',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (233, 554); --Immune: Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (233, 556); --Immune: Slow
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (233, 623); --Shell
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (233, 632); --Thwack
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (233, 'Either', 'Small', 'Rocktop', 6, 2, '2R', '1ST', '3B', '2B', 2, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (233, 'Elite', '8 Bit', 2);

--Slowpoke v1 --CardIndex 321 --CharacterIndex 234 --ExploreCharacterIndex 234
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Slowpoke v1',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (234, 554); --Immune: Knockdown
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (234, 556); --Immune: Slow
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (234, 623); --Shell
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
...
--Slowpoke v2 --CardIndex 322 --CharacterIndex 235 --ExploreCharacterIndex 235
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Slowpoke v2',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (235, 481); --Burrow
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (235, 623); --Shell
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (235, 'Either', 'Small', 'Rocktop', 5, 1, '3B', '1ST', '3B', '1B', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (235, 'Minion', '8 Bit', 1);

--Turtle Shell v1 --CardIndex 323 --CharacterIndex 236 --ExploreCharacterIndex 236
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Turtle Shell v1',
...
--Turtle Shell v2 --CardIndex 324 --CharacterIndex 237 --ExploreCharacterIndex 237
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Turtle Shell v2',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (237, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (237, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (237, 559); --Insignificant
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (237, 'Either', 'Small', 'Rocktop', 0, 0, '', '1ST', '', '', 2, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (237, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (237, 'Minion', '8 Bit', 0);

--Salt Pillar --CardIndex 325 --CharacterIndex 238 --ExploreCharacterIndex 238
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Salt Pillar',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (238, 638); --Stealth Aura
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (238, 682); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (238, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 3, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (238, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (238, '', 'Start', 0);

--Mist Hound --CardIndex 326 --CharacterIndex 239 --ExploreCharacterIndex 239
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Mist Hound',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (239, 596); --Predator
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (239, 624); --Sidestep
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (239, 641); --Surefoot
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (239, 421); --Lost
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (239, 'Either', 'Small', 'Faerie Wolf', 8, 2, '2B1R', '0ST', '1B1R', '3B', 2, 0);
...
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (239, 4); --Dexterity
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (239, 'Elite', '16 Bit', 2);

--Sorrow --CardIndex 327 --CharacterIndex 240 --ExploreCharacterIndex 240
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Sorrow',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (240, 518); --Fly
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (240, 667); --Weep
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (240, 'Either', 'Small', 'Faerie', 6, 1, '0ST', '0ST', '2B1R', '3B', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (240, 'Elite', '8 Bit', 1);

--Shallow Grave --CardIndex 328 --CharacterIndex 241 --ExploreCharacterIndex 241
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Shallow Grave',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (241, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (241, 471); --Bane Aura
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (241, 684); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (241, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 4, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (241, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (241, '', 'Start', 0);

--Bone Head --CardIndex 329 --CharacterIndex 242 --ExploreCharacterIndex 242
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Bone Head',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (242, 1); --Citrine
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (242, 477); --Bone Pile
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (242, 'Either', 'Small', 'Undead Skeleton', 6, 1, '3B', '1ST', '2B', '1B', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (242, 'Minion', '8 Bit', 1);

--Dread Knight --CardIndex 330 --CharacterIndex 243 --ExploreCharacterIndex 243
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Dread Knight',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (243, 1); --Citrine
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (243, 477); --Bone Pile
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (243, 249); --Cursed Blade
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (243, 'Either', 'Small', 'Undead Skeleton', 6, 2, '2B1R', '1ST', '2B', '1B', 2, 0);
...
--Dust Coven Necromancer --CardIndex 331 --CharacterIndex 244 --ExploreCharacterIndex 244
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (244, 322); --Tide of Bones
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (244, 281); --Renewed Vigor
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (244, 281); --Ghastly Vigor
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (244, 'Either', 'Small', 'Witch', 6, 3, '1B', '0ST', '2R', '2B', 3, 0);
...
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (244, 3); --Magic
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (244, 'Elite', '16 Bit', 2);

--Dust Mage --CardIndex 332 --CharacterIndex 245 --ExploreCharacterIndex 245
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Dust Mage',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (245, 3); --Ruby
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (245, 193); --Bone Cold
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (245, 438); --Mend Bones
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (245, 'Either', 'Small', 'Undead Skeleton', 6, 2, '1B', '0ST', '3B', '1B', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (245, 1, 1); --Strength
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (245, 3, 6); --Magic
...
--Tribal Stone --CardIndex 333 --CharacterIndex 246 --ExploreCharacterIndex 246
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Tribal Stone',
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (246, 557); --Immune: Status Effects
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (246, 597); --Primal Aura
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (246, 686); --Spawning Pool
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (246, 'Neither', 'Small', 'Spawning Point', 0, 0, '', '1ST', '', '', 3, 0);
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (246, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (246, '', 'Start', 0);

--Ghostfire Warrior --CardIndex 334 --CharacterIndex 247 --ExploreCharacterIndex 247
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Ghostfire Warrior',
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (247, 355); --Ghostfire
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (247, 'Either', 'Large', 'Troll', 6, 2, '2B1R', '1ST', '1B', '2B', 2, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (247, 1, 2); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (247, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (247, 'Minion', '8 Bit', 2);
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (248, 648); --Tough
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (248, 161); --Ancestral Wrath
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (248, 281); --Spirit Wind
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (248, 442); --Mistborn
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (248, 'Either', 'Large', 'Troll', 6, 2, '2B1R', '1ST', '1B1R', '2B', 3, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (248, 1, 3); --Strength
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (248, 2); --Armor
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (248, 'Elite', '16 Bit', 2);

--Spirit Walker --CardIndex 336 --CharacterIndex 249 --ExploreCharacterIndex 249
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES (
'Spirit Walker',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (249, 2); --Emerald
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (249, 518); --Fly
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (249, 586); --Pile-On
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (249, 322); --Flame Burst
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (249, 281); --Dive Bomb
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (249, 'Either', 'Small', 'Drake', 6, 2, '2B1R', '1ST', '3B', '3B', 1, 0);
...
insert into Monsters (ExploreCharacterIndex, RankType, Bits, Skulls) VALUES (249, 'Minion', '8 Bit', 1);

--FK Arcade Booty
--Boody Biter	--CardIndex 337	--CharacterIndex 250	--ArcadeCharacterIndex 1
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES ('Booty Biter',
...
--Bouncing Booty --CardIndex 338	--CharacterIndex 251	--ArcadeCharacterIndex 2
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES ('Bouncing Booty',
'http://htkb.info/SDE/FK/Cards/Arcade/Booty/Card_Arcade_Booty_Bouncing_Booty_FK_FK.png', 
'http://htkb.info/SDE/FK/Cards/Arcade/Booty/Card_Arcade_Booty_Bouncing_Booty_FK_FK_back.png', 
...
--Booty Grinder --CardIndex 339	--CharacterIndex 252	--ArcadeCharacterIndex 3
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES ('Booty Grinder',
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (252, 3); --Ruby
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (252, 152, -1);
--GangMemberIndex 3
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (255, 111, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (255, 3); --Ruby
--GangMemberIndex 6
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (256, 133, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (256, 1); --Citrine
--GangMemberIndex 7
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (257, 111, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (257, 2); --Emerald
--GangMemberIndex 8
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (260, 111, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (260, 4); --Sapphire
--GangMemberIndex 11
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (262, 3); --Ruby
--GangMemberIndex 13
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (268, 264, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (268, 1); --Citrine
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (270, 3); --Ruby
--GangMemberIndex 21
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (271, 366, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (271, 2); --Emerald
--GangMemberIndex 22
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (272, 4); --Sapphire
--GangMemberIndex 23
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (273, 256, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (273, 3); --Ruby
--GangMemberIndex 24
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (274, 246, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (274, 2); --Emerald
--GangMemberIndex 25
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (276, 264, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (276, 1); --Citrine
--GangMemberIndex 27
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (280, 373, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (280, 1); --Citrine
--GangMemberIndex 31
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (282, 2); --Emerald
--GangMemberIndex 33
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
insert into ArcadeCharacters (CharacterIndex, SoloStatLineIndex, GangStatLineIndex) 
VALUES (284, 263, -1);
insert into AffinityAssignments (CharacterIndex, AffinityIndex) VALUES (284, 4); --Sapphire
--GangMemberIndex 35
insert into GangMembers (ArcadeCharacterIndex, MemberOrder, Name, CreatureType, RankType, MemberMovement, MemberHealth, MemberArmor, ExploreCharacterIndex)
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Lava_Whirl/Blaze_Beetle.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
'Subsisting entirely on the molten rock of the Fire Flows, the Blaze Beetle is at home swimming through its magnificent lava rivers.  Blaze Beetles possess a remarkable sense of cruel cunning, burrowing beneath groups of Heroes to erupt from solid stone, bathing them in a shower of fire and rock.');
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Lava_Whirl/Flaming_Slime.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Old_Growth_Hollow/Old_Growth_Hollow.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
'The elves of the Fae Wood and the wise Deeproot Tree have long been friends and guardians of Crystalia.  Their timeless stewardship of the land made them ideal caretakers for the exiled Forgotten King and his court.<br>Yet the rise of the Dark Consul has sapped their ageless strength as they are beset on all sides, and the Forgotten King has become a cancer that corrupts from within.  As the Consul''s power rises, so too doees the Forgotten King''s and he has use his magic to sicken and bewitch the forest spirits within the Lordship Ruins.<br>Tswisted by the Forgotten King''s hatred, these corrupt kodama have lent their strength to the Dark Consul.  Now the elves find themselves under attack in their own woods.');
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Old_Growth_Hollow/Herbalists.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Old_Growth_Hollow/Hungry_Sprouts.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Old_Growth_Hollow/Lil_Sprouts.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Pumpkin_Patch/Pumpkin_Patch.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
'Long ago the inhabitants of the Glauerdoom Moor used pumpkins to carve jack-o-lanterns to trick the restless spirits of the moor to pass by their homes at night.  In time the spirits grew wise to this deception and decided to play a trick of their own.  Now pumpkin patches are spooky, haunted, places where the creatures that go bump in the night lurk, waiting for their prey.<br>Beneath the dark boughs of the Witches'' Weald pumpkins grow wild and the orange globes pulse with strange energies as the witch covens practice their own special brand of dark magic--poisons, necromancy, enchantment, curses, no subject is taboo.  The covensfind great favor with both the Dark Consul and Baron Von Drakk.  Both often have need of the witches'' unique abiliites when dealing with self righteous Heroes who seek to thwart them.');
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Pumpkin_Patch/Crypt_Spider.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Pumpkin_Patch/Curse_Coven.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Rock_Pile/Rock_Pile.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
'Rocktops can be found throughout Crystalia, wherever the earth is rocky and barren.  Due to their natural predilection to tunnel, Rocktops are superb miners.<br>Like many of the Consul''s minions, Rocktop society is ruled by strength and size.  At the top of the hierarchy stands the migty Crusher.  Dimwitted and brutish, Crushers spend most of their waking hours smashign rock to increase the size of the tunnel systems they claim as theirs.<br>In contrast, Rollers and Bombardiers are surprisingly jovial creatures.  Relishing in mischief and mayhem they delight in the noise and spectacle as rocks, Heroes, or anything weaker than them are smashed, smushed, crushed, crunched, or exploded.<br>Below them all are the hapless Slowpokes.  Simple creatures who if they had a say in it, would be perfectly content moving rocks from one side of a cave to another and back again.');
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Rock_Pile/Bully_Foremen.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Rock_Pile/Rockers_v1.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Rock_Pile/Rockers_v2.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
'Slowpokes often gather around the massive Crushers, seeking some measure of protection from the bullying Rollers.  Crushers pay the Slowpokes little regard, for they are far too busy happily crushing rock and expanding their cavern to notice the pleas of their smaller kin.');
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Salt_Pillar/Salt_Pillar.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
'The Mistmourn Coast is a dangerous place even for the natural inhabitants of the Fae Woods.  Outsiders fear the troll tribes of the Mistmourn, but those familiar with this perpetually shrouded wood know that the fae creatures are the true danger.<br>Magical and otherworldy, what motivates these creatures is unknown.  Shamans bind them to pillars of salt to stay their wrath or do the shaman''s bidding.  Yet these magics have a dark consequence.  When the spells of binding are broken the magics of the formerly bound fae are trapped with the shattered salt pillar.  Their essence infuses new life within the Salt and they are reborn as elemental golems.  Driven only by blind instinct these Salt golems lash out at any who are near.');
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Salt_Pillar/Despair_Shroud.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Salt_Pillar/Predators.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Shallow_Grave/Shallow_Grave.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
'The Glauerdoom Moor is a grim and foreboding place by any measure.  Its fetid fens and marshes remain perpetually shrouded beneath a grey fog.  Its great cities have long since faded, their glory reduced to crumbling ruins and sinking towers.  The landscape is dotted by vast mausoleums and endless crypts built to house the ever dwindling populations'' dead.<br>Tragically the dead do not rest long.  The amethyst power of necromancy infuses the land and the dead sleep uneasily.  Their slumber is but a bried respite.  Soon their master bids them to rise and take their place in his macabre host.');
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Shallow_Grave/Dust_Acolytes.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
...
'http://htkb.online/SDWiki/SDE/FK/Cards/Arcade/Warbands/Tribal_Stone/Tribal_Stone.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Arcade', 
'Not even the elves choose to make the Mistmourn Coast their home.  Indeed, only the Glimmerdusk Rangers frequent these lands that are perpetually locked in mist and steeped in fae magic.  It is no surprise then that many creatures of the Dark Realm sought sanctuary within the concealing shadows of the coast.<br>Most were driven mad with fright, as the fae creatures preyed on their minds with capricious tricks and dealy pranks.  Trolls, however, remained remarkably unaffected--perhaps shielded by their naturally dim intellect.  In time they became tolerated by the fae creatures if not welcomed.<br>The thin veil between worlds along the Mistmourn eventually brought the trolls into communion with their fallen ancestors.  Guided by their ancestors'' past experiences the trolls grew more cunning, some even attaining a level of brutal intelligence.');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (472, 'Right', '+1B STR');
...
'Loot', 'FK', 'FK Core Set', 'Default',
'Come at me!');
insert into Equipment (CardIndex, Position, Effect) VALUES (480, 'Right', '+1B ARM');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (492, 'Top', '+1R WILL');
...
'Loot', 'FK', 'FK Core Set', 'Default',
'Just a little stick.');
insert into Equipment (CardIndex, Position, Effect) VALUES (496, 'Left', '+1B DEX');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (501, 'Top', '+1R ARM');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (502, 'Right', '+1R ARM');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (511, 'Top', '+1ST STR');
...
'Loot', 'FK', 'FK Core Set', 'Default',
'Headbutt!');
insert into Equipment (CardIndex, Position, Effect) VALUES (512, 'Top', '+1ST STR');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (513, 'Top', '+1B STR');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (517, 'Left', '+1R DEX');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (523, 'Top', '+1ST DEX');
...
'Treasure', 'FK', 'FK Core Set', 'Default',
'Oh gross!');
insert into Equipment (CardIndex, Position, Effect) VALUES (527, 'Top', '+1G WILL');
...
'Treasure', 'FK', 'FK Core Set', 'Default',
'I''m on fire!');
insert into Equipment (CardIndex, Position, Effect) VALUES (528, 'Bottom', '+1R STR');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (530, 'Bottom', '+1G');
...
'Loot', 'FK', 'FK Core Set', 'Default',
'Solid as a rock.');
insert into Equipment (CardIndex, Position, Effect) VALUES (539, 'Top', '+1B ARM');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (547, 'Bottom', '+1R Heart');--
...
insert into Equipment (CardIndex, Position, Effect) VALUES (573, 'Left', '+1R STR');
...
'Loot', 'FK', 'FK Core Set', 'Default',
'They taste so good.');
insert into Equipment (CardIndex, Position, Effect) VALUES (592, 'Bottom', '+1 Potion');--
...
insert into Equipment (CardIndex, Position, Effect) VALUES (600, 'Top', '+1R DEX');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (607, 'Left', '+1B ARM');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (611, 'Top', '+1R DEX +1AC');
...
'Loot', 'FK', 'FK Core Set', 'Default',
'So luxurious.');
insert into Equipment (CardIndex, Position, Effect) VALUES (615, 'Right', '+1R DEX');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (622, 'Top', '+1R STR');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (625, 'Left', '+1B STR');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (627, 'Right', '+1ST ARM');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (641, 'Right', '+1B WILL');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (643, 'Left', '+1R WILL');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (645, 'Top', '+1B WILL');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (646, 'Top', '+1ST ARM');
