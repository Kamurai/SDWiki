...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 2); --Terrifying Screech
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 3); --Shapeshift
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (2, 4); --! To look at later
...
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (2,1,1); --! To look at later
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (2,2); --! To look at later
...
insert into Characters (CardIndex) VALUES (2); --! To look at later
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 2); --Magma
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 3); --Riddle of Steel
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 3); --Volcano
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (2, 4); --! To look at later
...
insert into Characters (CardIndex) VALUES (2); --! To look at later
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 2); --Dragon Breath
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 3); --Tail Sweep
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (2, 4); --! To look at later
...
insert into Characters (CardIndex) VALUES (2); --! To look at later
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 3); --Shapeshift
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 2); --Ghastly Vigor
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (2, 3); --Tide of Bones
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (2, 4); --! To look at later
...
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (2,1,1); --! To look at later
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (2,2); --! To look at later
insert into DefenseAssignments (ExploreCharacterIndex, AttributeIndex) VALUES (2,4); --! To look at later
insert into Monsters (ExploreCharacterIndex, Bits, Skulls) VALUES (2, 'Boss', 'Super', 4); --! To look at later
