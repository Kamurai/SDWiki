...
--Air Shrine Clan --CardIndex cXXX --TeamIndex 0
...
insert into KeywordAssignments (TeamIndex, KeywordIndex) VALUES (0, kXXX); --Combat Results

--Earth Shrine Clan --CardIndex cXXX --TeamIndex 1
insert into Teams (TeamName, Quickplay)
...
insert into KeywordAssignments (TeamIndex, KeywordIndex) VALUES (1, kXXX); --Combat Results

--Fire Shrine Clan --CardIndex cXXX --TeamIndex 2
insert into Teams (TeamName, Quickplay)
...
insert into KeywordAssignments (TeamIndex, KeywordIndex) VALUES (2, kXXX); --Combat Results

--Spirit Shrine Clan --CardIndex cXXX --TeamIndex 3
insert into Teams (TeamName, Quickplay)
...
insert into KeywordAssignments (TeamIndex, KeywordIndex) VALUES (3, kXXX); --Combat Results

--Void Shrine Clan --CardIndex cXXX --TeamIndex 4
insert into Teams (TeamName, Quickplay)
...
insert into KeywordAssignments (TeamIndex, KeywordIndex) VALUES (4, kXXX); --Combat Results

--Water Shrine Clan --CardIndex cXXX --TeamIndex 5
insert into Teams (TeamName, Quickplay)
