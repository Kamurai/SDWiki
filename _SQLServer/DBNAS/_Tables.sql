...
--Keywords
create table Keywords (KeywordIndex bigint IDENTITY(0,1) PRIMARY KEY, KeywordVersion varchar(20) not null, KeywordType varchar(20) not null, KeywordName varchar(50) not null, KeywordDescription varchar(2500) not null);
...
create table AffinityAssignments (AffinityAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, AffinityIndex bigint not null, ShinobiIndex bigint not null);

--Moon Cards
create table MoonCards (MoonCardIndex bigint IDENTITY(0,1) PRIMARY KEY, CardIndex bigint not null, MoonCardCondition varchar(2500) not null, MoonCardAffinityMatch varchar(2500) not null );
...
create table KeywordAssignments (KeywordAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, KeywordIndex bigint not null, ShinobiIndex bigint, MoonCardIndex bigint, UtilityIndex bigint);
