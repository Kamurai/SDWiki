...
'http://htkb.info/SDE/1.0/Cards/Heroes/Card_Loot_1.0_back.png', 
...
'Loot', '1.0', '1.0 Core Set', 'Default',
'Ouch!');
insert into Equipment (Position, Effect) VALUES ('Top', '+1B DEX'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
insert into Equipment (Position, Effect) VALUES ('Top', '+1B Armor'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
'Loot', '1.0', '1.0 Core Set', 'Default',
'It lives!');
insert into Equipment (Position, Effect) VALUES ('Top', 'At the beginning of the round Resurrect one model and then remove this card from play.  If the Consul draws this card shuffle it back into the Loot Deck and draw again.'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
insert into Equipment (Position, Effect) VALUES ('Top', '+1R Armor'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
insert into Equipment (Position, Effect) VALUES ('Top', '+1B WILL'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
insert into Equipment (Position, Effect) VALUES ('Top', '+1R WILL'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
'Loot', '1.0', '1.0 Core Set', 'Default',
'RAAAAARGH!');
insert into Equipment (Position, Effect) VALUES ('Top', '+1Star Attack'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
insert into Equipment (Position, Effect) VALUES ('Top', '+1Star Armor'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
'Loot', '1.0', '1.0 Core Set', 'Default',
'Quick and sure.');
insert into Equipment (Position, Effect) VALUES ('Top', '+1Star DEX'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
'Loot', '1.0', '1.0 Core Set', 'Default',
'Bigger and uglier.');
insert into Equipment (Position, Effect) VALUES ('Top', '+1R Attack'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
'Loot', '1.0', '1.0 Core Set', 'Default',
'Silence and grace.');
insert into Equipment (Position, Effect) VALUES ('Top', '+1R DEX'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
'Loot', '1.0', '1.0 Core Set', 'Default',
'There is no spoon.');
insert into Equipment (Position, Effect) VALUES ('Top', '+1Star WILL'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
