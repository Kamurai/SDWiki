...
insert into KeywordAssignments (KeywordIndex, EquipmentIndex) VALUES (2, 3); --Choke
--Coward's Boots
...
'Loot', '1.0', '1.0 Core Set', 'Default',
'It lives!');
insert into Equipment (Position, Effect) VALUES ('Bottom', 'At the beginning of the round Resurrect one model and then remove this card from play.  If the Consul draws this card shuffle it back into the Loot Deck and draw again.'); --? Not sure that this should be "Equipment" and the values need to be checked - everything about this line needs to be checked - could not find anything about Loot in the _Tables.sql and _DataLoad_Scratch.sql files --
...
insert into Equipment (Position, Effect) VALUES ('Left', '+1B Attack');
insert into KeywordAssignments (KeywordIndex, EquipmentIndex) VALUES (2, 3); --Weak
--Serpent Plate
...
insert into Equipment (Position, Effect) VALUES ('Right', '+1B Armor');
insert into KeywordAssignments (KeywordIndex, EquipmentIndex) VALUES (2, 3); --Immune: Poison
--Serpent Sword
...
insert into Equipment (Position, Effect) VALUES ('Left', '+1B Attack');
insert into KeywordAssignments (KeywordIndex, EquipmentIndex) VALUES (2, 3); --Poison
--Silver Torq
...
insert into KeywordAssignments (KeywordIndex, EquipmentIndex) VALUES (2, 3); --Immune: Choke
--Sneaky Stilletto
...
insert into Equipment (Position, Effect) VALUES ('Left', '+1B DEX');
insert into KeywordAssignments (KeywordIndex, EquipmentIndex) VALUES (2, 3); --Slow
--Sorcerer's Cowl
...
insert into KeywordAssignments (KeywordIndex, EquipmentIndex) VALUES (2, 3); --Stun
--Spiked Gauntlets
