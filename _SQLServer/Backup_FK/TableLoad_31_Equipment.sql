...
--Wyrm Scale --EquipmentIndex 79 --CardIndex 151
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES ('Wyrm Scale',
'http://htkb.info/SDE/FK/Cards/Treasure/Generic/Card_Treasure_Wyrm_Scale_FK.png', 
'http://htkb.info/SDE/FK/Cards/Treasure/Generic/Card_Treasure_Back_FK.png',
'http://htkb.online/SDWiki/SDE/FK/Cards/Generic/Specific/Wyrm_Scale.xhtml', 
'Treasure', 'FK', 'FK Core Set', 'Default',
'Woooosh!');
insert into Equipment (CardIndex, Position, Effect) VALUES (150, 'Top', '+1G Armor');
insert into AbilityAssignments (EquipmentIndex, AbilityIndex) VALUES (78, 46); --Fire Storm
...
--Wyrm Scale --EquipmentIndex 79 --CardIndex 151
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES ('Wyrm Scale',
'http://htkb.info/SDE/FK/Cards/Treasure/Pets/Card_Treasure_Wyrm_Scale_FK.png', 
'http://htkb.info/SDE/FK/Cards/Treasure/Pets/Card_Treasure_Back_FK.png',
'http://htkb.online/SDWiki/SDE/FK/Cards/Pets/Specific/Wyrm_Scale.xhtml', 
'Treasure', 'FK', 'FK Core Set', 'Default',
'Woooosh!');
insert into Equipment (CardIndex, Position, Effect) VALUES (150, 'Top', '+1G Armor');
insert into AbilityAssignments (EquipmentIndex, AbilityIndex) VALUES (78, 46); --Fire Storm
...
--EquipmentIndex 79 --CardIndex 151
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES ('Wyrm Scale',
'http://htkb.info/SDE/FK/Cards/Treasure/Booty/Card_Treasure_Wyrm_Scale_FK.png', 
'http://htkb.info/SDE/FK/Cards/Treasure/Card_Treasure_Back_FK.png',
'http://htkb.online/SDWiki/SDE/FK/Cards/Booty/Specific/Wyrm_Scale.xhtml', 
'Treasure', 'FK', 'FK Core Set', 'Default',
'Woooosh!');
insert into Equipment (CardIndex, Position, Effect) VALUES (150, 'Top', '+1G Armor');
insert into AbilityAssignments (EquipmentIndex, AbilityIndex) VALUES (78, 46); --Fire Storm
...
'http://htkb.info/SDE/FK/Cards/Loot/Card_Loot_Caltrop_Dagger_FK.png', 
'http://htkb.info/SDE/FK/Cards/Loot/Card_Loot_Back_FK.png', 
'http://htkb.online/SDWiki/SDE/FK/Cards/Loot/Caltrop_Dagger.xhtml', 
...
--Acorn of Life--EquipmentIndex 79 --CardIndex 151
...
insert into AbilityAssignments (EquipmentIndex, AbilityIndex) VALUES (78, 505); 


--Amethyst Crystal Shard--EquipmentIndex 79 --CardIndex 151
...
--Ancestral Mail --EquipmentIndex 79 --CardIndex 151
...
--Arcane Tome --EquipmentIndex 9 --CardIndex 81
...
'Loot', 'FK', 'FK Core Set', 'Default',
'Knowledge is power.');
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Right', '+1R WILL');
insert into KeywordAssignments (EquipmentIndex, KeywordIndex) VALUES (9, 49); --Immobile


--Arcanist Armor--Arcasnist Bracers
--Arena Champion
--Arena Plate


--Assassin's Crossbow--EquipmentIndex 79 --CardIndex 151
...
--Bent Nail --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Bent Nail',
...
insert into KeywordAssignments (EquipmentIndex, KeywordIndex) VALUES (9, 552); --Immune Hex


--Bewitched Wand--EquipmentIndex 79 --CardIndex 151
...
--Black Spot--EquipmentIndex 79 --CardIndex 151
...
--Blue Shell--EquipmentIndex 79 --CardIndex 151
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Right', '+1B STR');


--Brawlers Knife

--Burning Eye --EquipmentIndex 79 --CardIndex 151
...
--Burnt Twig         --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Burnt Twig',
...
'Loot', 'FK', 'FK Core Set', 'Default',
'Surprisingly warm.');
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Bottom', '+1B DEX');
insert into KeywordAssignments (EquipmentIndex, KeywordIndex) VALUES (9, 553); --Immune Ice


--Cats Paw--EquipmentIndex 79 --CardIndex 151
...
--Chainmail --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Chainmail',
...
'Loot', 'FK', 'FK Core Set', 'Default',
'Come at me!');
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Right', '+1B ARM');
...
--Cheese Head  --EquipmentIndex 79 --CardIndex 151
...
--Cloak of Wards --EquipmentIndex 79 --CardIndex 151
...
--Crystal Shard     --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Crystal Shard',
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Top', '+1R WILL');


--Cursed Talisman--EquipmentIndex 79 --CardIndex 151
...
--Deadly Dirk     --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Deadly Dirk',
...
--Death Scythe--EquipmentIndex 79 --CardIndex 151
...
'Treasure', 'FK', 'FK Core Set', 'Default',
'');
insert into Equipment (CardIndex, Position, Effect) VALUES (150, 'Top', '+1B STR +1B ARM +1B WILL +1B DEX');
...
--Diamond Helm  --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Diamond Helm',
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Top', '+1R ARM');


--Diamond Plate     --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Diamond Plate',
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Right', '+1R ARM');


--Dirty Penny     --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Dirty Penny',
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Bottom', '+1B ARM');
insert into KeywordAssignments (EquipmentIndex, KeywordIndex) VALUES (9, 550); --Immune Bane


--Divine Vestment--EquipmentIndex 79 --CardIndex 151
...
--Dragon Bow--EquipmentIndex 79 --CardIndex 151
...
--Dwarven Axe --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Dwarven Axe',
...
--Monstrous Maul--EquipmentIndex 79 --CardIndex 151
...
--Moon Bow
--Mournful Vial
--Mysterious Travelers Cloak

--Nether Sword--EquipmentIndex 79 --CardIndex 151
...
--Riftling Orb     --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Riftling Orb',
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Top', '+1R DEX');


--Roaring Pendant of the Wood
--Roxors Bane
--Royal Cloak

--Ruby Crystal Shard--EquipmentIndex 79 --CardIndex 151
...
'Loot', 'FK', 'FK Core Set', 'Default',
'So luxurious.');
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Right', '+1R DEX');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Top', '+1R STR');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Right', '+1ST ARM');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Right', '+1B WILL');


--Witch Wand     --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Witch Wand',
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Left', '+1R WILL');
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Top', '+1B WILL');


--Wizard Ring     --EquipmentIndex 9 --CardIndex 81
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor)
VALUES ('Wizard Ring',
...
insert into Equipment (CardIndex, Position, Effect) VALUES (81, 'Left', '+1B WILL');
insert into KeywordAssignments (EquipmentIndex, KeywordIndex) VALUES (9, 512); --Fire
