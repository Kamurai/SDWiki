...
--The Colonel --CardIndex 215	--CharacterIndex 128	--ExploreCharacterIndex 128
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (128, 618); --Tactical Strike
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (128, 'Either', 'Small', 'Wonder', 6, 1, '2R', '3B', '', '', 0, 0);
...
--Lord Gruff --CardIndex 216	--CharacterIndex 129	--ExploreCharacterIndex 129
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (129, 573); --Master Gains Knockdown
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (129, 364); --Grump
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (129, 'Masculine', 'Small', 'Wonder', 6, 1, '3B', '3ST', '', '', 0, 0);
...
--Madam Hilde --CardIndex 217	--CharacterIndex 130	--ExploreCharacterIndex 130
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (130, 574); --Master Gains Soprano
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (130, 575); --Soprano
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (130, 'Feminine', 'Small', 'Wonder', 6, 1, '1B1R', '3ST', '', '', 0, 0);
...
--Miss G. Snorts --CardIndex 218	--CharacterIndex 131	--ExploreCharacterIndex 131
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (131, 575); --Master Gains Poison
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (131, 599); --Stink Beard Bark
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (131, 'Feminine', 'Small', 'Wonder', 6, 1, '3B', '2ST', '', '', 0, 0);
...
--Mr. Chompers --CardIndex 219	--CharacterIndex 132	--ExploreCharacterIndex 132
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (132, 576); --Master Gains Fire
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (132, 489); --Poof
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (132, 'Masculine', 'Small', 'Wonder', 6, 1, '2R', '2ST', '', '', 0, 0);
...
--Mr. Bitey --CardIndex 220	--CharacterIndex 133	--ExploreCharacterIndex 133
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (133, 577); --Master Gains Berserk
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (133, 531); --Rotten Carrot
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (133, 'Masculine', 'Small', 'Wonder', 6, 2, '2R', '2ST', '', '', 0, 0);
...
--Never-Lost Cola --CardIndex 221	--CharacterIndex 134	--ExploreCharacterIndex 134
