--FK Creeps
--Citrine Slime --CardIndex 222	--CharacterIndex 138	--ExploreCharacterIndex 138
...
--Emerald Slime --CardIndex 223	--CharacterIndex 139	--ExploreCharacterIndex 139
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (139, 303); --Emerald Glop
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
...
--Ghost --CardIndex 224	--CharacterIndex 140	--ExploreCharacterIndex 140
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (140, 522); --Ghost
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (140, 612); --Shallow Grave
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (140, 309); --Extra Scared
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (140, 'Either', 'Small', 'Undead Ghost', 5, 1, '0ST', '0ST', '2B', '3B', 1, 0);
...
--Giri --CardIndex 225	--CharacterIndex 141	--ExploreCharacterIndex 141
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (141, 580); --Mob
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (141, 451); --New Crop
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (141, 'Either', 'Small', 'Faerie', 5, 1, '2B', '0ST', '3B', '2B', 1, 0);
insert into OffenseAssignments (ExploreCharacterIndex, AttributeIndex, OffenseRange) VALUES (141, 1, 2);
...
--Rabid Squirrel --CardIndex 226	--CharacterIndex 142	--ExploreCharacterIndex 142
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (142, 451); --In Your Pants
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (142, 'Either', 'Small', 'Chimera', 7, 1, '1B', '0ST', '1B', '2R', 1, 0);
...
--Rattlebone --CardIndex 227	--CharacterIndex 143	--ExploreCharacterIndex 143
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (143, 580); --Mob
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (143, 'Either', 'Small', 'Undead Skeleton', 6, 1, '2B', '0ST', '1B', '1B', 1, 0);
...
--Ruby Slime --CardIndex 228	--CharacterIndex 144	--ExploreCharacterIndex 144
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (144, 559); --Invader
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (144, 626); --Ruby Goo
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (144, 303); --Ruby Goo
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
...
--Sapphire Slime --CardIndex 229	--CharacterIndex 145	--ExploreCharacterIndex 145
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (145, 534); --Sapphire Gloop
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
