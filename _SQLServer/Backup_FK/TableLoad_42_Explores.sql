...
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (646, 'After the spawning point is destroyed, you may draw one loot card per Hero.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);


--Blue Button Stuck	--CardIndex 647	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (647, 'Models may not use unique support actions.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);


--Choking Cloud	--CardIndex 648	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
--Creep Factory	--CardIndex 649	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
--Grasping Tentacles	--CardIndex 650	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
--Jammed Coin Slot	--CardIndex 651	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Please don''t die.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (651, 'While any Hero is in this tile Princess Coins may not be used.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);


--Locked Doors	--CardIndex 652	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (652, 'Heroes who enter this tile may not leave it until the party spends 1 dungeon key to unlock the doors.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);


--Pathing Error	--CardIndex 653	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (653, 'All models may move through walls. Line of sight is blocked as normal.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);


--Potion Stash	--CardIndex 654	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (654, 'Place 4 potion tokens in the corner squares adjacent to the spawning point. Heroes may use the Pick Up basic action to add them to their card.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);


--Red Button Stuck	--CardIndex 655	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (655, 'Models may not use unique offensive actions.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);


--Save Point	--CardIndex 656	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (656, 'After the spawning point is destroyed Heroes may remove all status effects.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);


--Secret Code	--CardIndex 657	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (657, 'Add one Princess Coin to the party''s backpack.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);


--Spiked Floor	--CardIndex 658	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
--Traveling Merchant	--CardIndex 659	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (659, 'The Heroes may discard up to three pieces of loot, then draw the same number of loot cards.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);


--Treasure Vault	--CardIndex 660	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Jackpot!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (660, 'After the mini-boss is spawned and destroyed, instead of drawing a single treasure card, the party may draw one per Hero.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);


--Turbo Button	--CardIndex 661	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (661, 'While in this tile a Hero gains +1AC and +1MO.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);


--Wall of Fire	--CardIndex 662	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
--Antidote	--CardIndex 663	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (664, 'All Heroes suffer slow.');
insert into Explores (UtilityIndex) VALUES (uXXX);
...
--Bubbling Cauldron	--CardIndex 665	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Don''t drink that!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (665, '3ST, 2x2');
insert into Explores (UtilityIndex) VALUES (uXXX);
...
--Glitched Doorway	--CardIndex 666	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (666, 'Models may move through walls on this tile''s edge.  Line of sight is blocked as normal.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Beatrix the Witch Queen


--Grave Robbers	--CardIndex 667	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (667, 'A Hero may draw up to four loot cards during their turn.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Beatrix the Witch Queen


--Pumpkin Mines	--CardIndex 668	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Watch your step.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (668, '1St, 2x2');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 496);--Pumpkin Shrapnel


--Pumpkin Pie	--CardIndex 669	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (669, 'Place card in the backpack.  The party may discard this card at any time to remove one wound token from every friendly model.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Beatrix the Witch Queen


--Bramble Wall	--CardIndex 670	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (670, '2ST, 1x4');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 626);--Thorns


--Corrupted Tree	--CardIndex 671	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (671, '3ST, 2x2');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 629);--Thrashing Limbs


--Dancing Light	--CardIndex 672	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (672, '0ST, 2x2, Heroes must always end their activation closer to a Dancing Light template than they began.  If a Hero ends their activation adjacent to a Dancingt Light template remove the template from play.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--The Forgotten King


--Faerie Pool	--CardIndex 673	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'You caught a faerie!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (673, 'After the spawning point is destroyed all Heroes remove one wound token.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--The Forgotten King


--Friendly Chimera	--CardIndex 674	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'They''re so adorable!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (674, 'Hero players choose, spawn, and control all creep models on this tile, instead of the Consul.  Creeps may be activated during the Hero Turn in addition to any other models.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--The Forgotten King


--Gypsy Princess	--CardIndex 675	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Why hello there.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (675, 'Human, Freyjan, and Demon Heroes add +1ST to all offense rolls.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--The Forgotten King


--Lost Unicorn	--CardIndex 676	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'So I like unicorns...');
insert into Utilities (CardIndex, UtilityDescription) VALUES (676, 'Elf, Celestian, Dwarf, and Gnome Heroes add +1ST to all defense rolls.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--The Forgotten King


--Mistmourn Fog	--CardIndex 677	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (677, 'All ranges are reduced by 3 to a minimum of 1.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--The Forgotten King


--Berry Patch	--CardIndex 678	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Don''t eat those.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (678, '1ST, 2x2');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 341);--Frost Berries


--Campfire	--CardIndex 679	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (679, 'Heroes gain the ability FIRE.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Goro


--Dirty Bison	--CardIndex 680	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (680, 'Add one pet, of the Heroes'' choice, to the backpack.  If its card is in the treasure deck remove it and reshuffle the deck.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Goro


--Downpour	--CardIndex 681	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (681, 'All models gain IMMUNE: FIRE and +2MO.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Goro


--Faery Queen	--CardIndex 682	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Ah-hah-hah-ha!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (682, 'All Heroes roll 1B for every wound token on their model.  Remove one wound token for every star rolled.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Goro


--Giant Centipede	--CardIndex 683	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'');
insert into Utilities (CardIndex, UtilityDescription) VALUES (683, '4ST, 1x4');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 399);--Icky


--Howling Wind	--CardIndex 684	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'I can''t hear you!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (684, 'Players controlling Heroes in this tile may not speak to other players while their model remains in the tile.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Goro


--Respec	--CardIndex 685	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Lets try this again.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (685, 'Remove all equipment from all Heroes and discard it.  Heroes may immediately equip any equipment from the loot or treasure discard piles.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Goro


--1-Up	--CardIndex 686	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Save this for later.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (686, 'Add one Princess Coin to the party''s backpack.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Roxor


--Dusty Cartridge	--CardIndex 687	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Blow on it.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (687, 'Choose one Hero.  All monsters within 3 squares suffer KNOCKDOWN.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Roxor


--Fire Flowers	--CardIndex 688	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (688, '1ST, 2x2');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 391);--Hot, Hot, Hot!


--Funny Costumes	--CardIndex 689	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'You look adorable.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (689, 'When a Hero enters this tile they may draw one treasure card.  They may use the treasure card exactly as if it were equipped.  Discard the card after leaving the tile.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Roxor


--Heroic Princess	--CardIndex 690	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Well done princess!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (690, 'After destroying this tile''s mini-boss add one Princess Coin to the party''s backpack.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Roxor


--Pixelated	--CardIndex 691	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Go straight, please.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (691, 'Heroes cannot move diagonally.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Roxor


--POW!	--CardIndex 692	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
--Stone Wall	--CardIndex 693	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'It''s solid rock.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (693, '5ST, 1x4, Models may not move or draw line of sight through Stone Wall template.  When Stone Wall is triggered its effect continues until disarmed.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Roxor


--Burglar's Ring	--CardIndex 694	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Can''t see me.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (694, 'Choose one Hero.  An enemy model may only target that Hero if it is within 1 square of the model.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Starfire


--Dragon Pot	--CardIndex 695	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Smells of sulfur.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (695, '2ST, 2x2');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 189);--Boom


--Dwarven Ale	--CardIndex 696	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'That''s a good brew!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (696, 'When the spawning point is destroyed, all Heroes remove all wound tokens, and then suffer POISON.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Starfire


--Kidnapped Villager	--CardIndex 697	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (697, 'When the mini-boss is destroyed, draw one additional treasure card.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Starfire


--Molten Steel	--CardIndex 698	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'My sword is bendy.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (698, '2ST, 1x4');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 437);--Melty Weapons


--Mountain of Gold	--CardIndex 699	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'So tall.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (699, 'Until the spawning point is destroyed all models halve their movement, rounding up.  This effect does not stack with SLOW.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Starfire


--New Player	--CardIndex 700	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (700, 'Choose one Hero that is not being played and place it in the tile.  It may be activated once during any Hero''s Turn.  Then remove it from play.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Starfire


--Sacrificial Altar	--CardIndex 701	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Give to the Dragon.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (701, 'Choose one Hero.  An enemy model may only target that Hero if it is within 1 square of the model.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 458);--Offering


--Abandoned Mine Shaft	--CardIndex 702	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Ahhhhhh!!!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (702, '2ST, 2x2, Place affected Heroes adjacent to the start marker.  Place affected monsters adjacent to the nearest spawning point.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Testudo Tower


--Bomb Flower	--CardIndex 703	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (703, 'Discard during a Hero''s activation to perform the action:');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 308);--Explode


--Bumper Shells	--CardIndex 704	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (704, '1ST, 2x2, When a model is affected by Bumper Shells, its player may move the model 3 squares using the rules for push.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Testudo Tower


--Handy Tunnel	--CardIndex 705	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'I think it''s safe.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (705, 'Discard during a Hero''s upkeep.  The Hero may move through walls, and treats difficult terrain and structure squares as open squares until the end of its activation.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Testudo Tower


--Shell Up	--CardIndex 706	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Turtle power!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (706, 'Discard before making a defense roll to add +1R to the roll.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Testudo Tower


--Testudo Formation	--CardIndex 707	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Form on me.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (707, 'Discard during a Hero''s upkeep.  Remove all status effect tokens from the Hero, and all adjacent Heroes.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Testudo Tower


--Bone Rot	--CardIndex 708	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'I don''t feel good.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (708, '2ST, 2x2');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 209);--Brittle Bone


--Cackling Laughter	--CardIndex 709	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'That''s just creepy.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (709, 'Players who cackle maniacally when making offense rolls may add +1B to the roll.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Von Drakk


--Ghost Well	--CardIndex 710	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'I''m see-through!');
insert into Utilities (CardIndex, UtilityDescription) VALUES (710, 'All models ignore walls and structures for purposes of line of sight and movement.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 2);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Von Drakk


--Bone Rot	--CardIndex 711	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
insert into Cards (Name, PictureFront, PictureBack, Link, CardType, ProductSet, ProductModule, PlayMode, Flavor) VALUES ('Bone Rot',
'http://htkb.info/SDE/FK/Cards/Utility/Explore/Specific/Von_Drakk/Card_Explore_Bone_Rot_FK.png', 
'http://htkb.info/SDE/FK/Cards/Utility/Explore/Card_Explore_FK_Back.png', 
'http://htkb.online/SDWiki/SDE/FK/Cards/Utility/Explore/Bone_Rot.xhtml', 
'Warband', 'FK', 'FK Core Set', 'Default', 
'I don''t feel good.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (711, '2ST, 2x2');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, 209);--Brittle Bone


--Hidden Lever	--CardIndex 712	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (712, 'Rotate the tile 90 degrees clockwise.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Von Drakk


--Secret Passsage	--CardIndex 713	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (713, 'Heroes place one token in a square on this tile and one in any other tile.  These squares count as Secret Passage Tile Effects for the rest of game.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Von Drakk


--Sore Thumbs	--CardIndex 714	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
'Warband', 'FK', 'FK Core Set', 'Default', 
'Take a break.');
insert into Utilities (CardIndex, UtilityDescription) VALUES (714, 'No models may use unique actions.');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 1);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Von Drakk


--Soul Spike	--CardIndex 715	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (715, 'Spawning Point gains Backlash.  (If a model with Backlash exceeds an offense roll with their defense roll the attacker takes one wound.)');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 3);
insert into ExploreAssignments (ExploreIndex, CharacterIndex) VALUES (eXXX, chXXX);--Von Drakk


--Webs	--CardIndex 716	--UtilityIndex uXXX	--ExploreIndex eXXX	--ExploreCreepIndex	--ExploreTrapIndex
...
insert into Utilities (CardIndex, UtilityDescription) VALUES (716, '1ST, 2x2');
insert into Explores (UtilityIndex) VALUES (uXXX);
insert into ExploreCreeps (ExploreIndex, CreepNumber) VALUES (eXXX, 0);
