--FK Pets
--Pets --Admiral Fuzzybottom --CardIndex 214	--CharacterIndex 129	--ExploreCharacterIndex 129
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (129, 572); --Master Gains Happy Cat
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (129, 366); --Happy Cat
...
VALUES (129, 'Either', 'Small', 'Wonder', 7, 1, '3B', '2ST', '', '', 0, 0);
...
--The Colonel --CardIndex 215	--CharacterIndex 130	--ExploreCharacterIndex 130
...
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (130, 618); --Tactical Strike
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (130, 'Either', 'Small', 'Wonder', 6, 1, '2R', '3B', '', '', 0, 0);
...
--Lord Gruff --CardIndex 216	--CharacterIndex 131	--ExploreCharacterIndex 131
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (131, 573); --Master Gains Knockdown
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (131, 364); --Grump
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (131, 'Masculine', 'Small', 'Wonder', 6, 1, '3B', '3ST', '', '', 0, 0);
...
--Madam Hilde --CardIndex 217	--CharacterIndex 132	--ExploreCharacterIndex 132
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (132, 574); --Master Gains Soprano
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (132, 575); --Soprano
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (132, 'Feminine', 'Small', 'Wonder', 6, 1, '1B1R', '3ST', '', '', 0, 0);
...
--Miss G. Snorts --CardIndex 218	--CharacterIndex 133	--ExploreCharacterIndex 133
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (133, 575); --Master Gains Poison
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (133, 599); --Stink Beard Bark
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (133, 'Feminine', 'Small', 'Wonder', 6, 1, '3B', '2ST', '', '', 0, 0);
...
--Mr. Chompers --CardIndex 219	--CharacterIndex 134	--ExploreCharacterIndex 134
...
insert into KeywordAssignments (ExploreCharacterIndex, KeywordIndex) VALUES (134, 576); --Master Gains Fire
insert into AbilityAssignments (ExploreCharacterIndex, AbilityIndex) VALUES (134, 489); --Poof
insert into ExploreCharacters (CharacterIndex, Gender, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) 
VALUES (134, 'Masculine', 'Small', 'Wonder', 6, 1, '2R', '2ST', '', '', 0, 0);
...
--Mr. Bitey --CardIndex 220	--CharacterIndex 135	--ExploreCharacterIndex 135
...
--Never-Lost Cola --CardIndex 221	--CharacterIndex 136	--ExploreCharacterIndex 136
