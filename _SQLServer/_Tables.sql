--drop table Cards, Characters, Affinities, Affinity_Assignments, Keywords, Keyword_Assignments, Abilities, Abiliity_Assignments, ExploreCharacters, Offenses, Offense_Assignments, Pets, Monsters, ArcadeCharacters, Equipment, Equipment_Assignments, BossSpawns, BossSpawn_Assignments, Utilities, ExploreTraps, ExploreCreeps, Explore_Assignments, Challenges, Plots, MightyMonsters;
...
create table Affinities (AffinityIndex bigint IDENTITY(0,1) PRIMARY KEY, Variant varchar(50) not null);
insert into Affinities (Variant) VALUES ('Amethyst');
insert into Affinities (Variant) VALUES ('Citrine');
insert into Affinities (Variant) VALUES ('Emerald');
insert into Affinities (Variant) VALUES ('Ruby');
insert into Affinities (Variant) VALUES ('Sapphire');

create table AffinityAssignments (AffinityAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, CharacterIndex bigint not null, AffinityIndex bigint not null);
...
create table KeywordAssignments (KeywordAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, KeywordIndex bigint not null, CharacterIndex bigint not null, GangMemberIndex bigint not null);
...
create table AbilityAssignments (AbilityAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, AbilityIndex bigint not null, CharacterIndex bigint not null, GangMemberIndex bigint not null, EquipmentIndex bigint not null, EventTrapIndex bigint not null);
...
create table OffenseAssignments (OffenseAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, CharacterIndex bigint not null, AttributeIndex bigint not null, OffenseRange int not null);
create table DefenseAssignments (DefenseAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, CharacterIndex bigint not null, AttributeIndex bigint not null);
...
create table ArcadeCharacters (ArcadeCharacterIndex bigint IDENTITY(0,1) PRIMARY KEY, CharacterIndex bigint not null);
create table SoloStatLines (SoloStatIndex bigint IDENTITY(0,1) PRIMARY KEY, ArcadeCharacterIndex bigint not null, SoloAction int not null, SoloStrength int not null, SoloRange int not null);
create table GangStatLines (GangStatIndex bigint IDENTITY(0,1) PRIMARY KEY, ArcadeCharacterIndex bigint not null, GangAction int not null, GangStrength int not null, GangRange int not null);
create table GangMembers (GangMemberIndex bigint IDENTITY(0,1) PRIMARY KEY, ArcadeCharacterIndex bigint not null, MemberOrder int not null, Name varchar(10) not null, CreatureType varchar(30) not null, RankType varchar(30) not null, MemberMovement int not null, MemberHealth int not null, MemberArmor int not null);
create table Equipment (EquipmentIndex bigint IDENTITY(0,1) PRIMARY KEY, Position varchar(50) not null, Effect varchar(50) not null);
create table BossSpawns (BossSpawnIndex bigint IDENTITY(0,1) PRIMARY KEY, Spawn varchar(50) not null, Effect varchar(50) not null, TimeoutEffect varchar(50) not null);
create table BossSpawn_Assignments (BossSpawnAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, CharacterIndex bigint not null);
...
create table ExploreCreeps (ExploreCreepIndex bigint IDENTITY(0,1) PRIMARY KEY, UtilityIndex bigint not null, CreepNumber varchar(50) not null);
create table ExploreCreep_Assignments (ExploreAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, UtilityIndex bigint not null, CharacterIndex bigint not null);
create table ExploreTraps (ExploreTrapIndex bigint IDENTITY(0,1) PRIMARY KEY, UtilityIndex bigint not null, TrapDefense int not null, TrapLayout varchar(10) not null, TrapAbilityName varchar(20) not null, TrapAbilityType varchar(10) not null, TrapAbilityDescription varchar(100) not null);
create table ExploreTrapAssignments (ExploreAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, ExploreTrapIndex bigint not null, CharacterIndex bigint not null);
...
create table Challenge_Assignments (ChallengeAssignmentIndex bigint IDENTITY(0,1) PRIMARY KEY, ChallengeIndex bigint not null, CharacterIndex bigint not null);
