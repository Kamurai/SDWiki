...
insert into Characters (CardIndex) VALUES (0);
insert into KeywordAssignments (CharacterIndex, KeywordIndex) VALUES (1, 0); --? Not sure what to put here & check all values for this and the following three
...
insert into OffenseAssignments (CharacterIndex, AttributeIndex, OffenseRange) VALUES (0,0,1);--? Not sure what to put for values
insert into DefenseAssignments (CharacterIndex, AttributeIndex) VALUES (0,2);--? Not sure what to put for values
...
insert into Characters (CardIndex) VALUES (0);
insert into KeywordAssignments (CharacterIndex, KeywordIndex) VALUES (1, 0); --Healer --? Not sure what to put here & check all values for this and the following three
...
insert into OffenseAssignments (CharacterIndex, AttributeIndex, OffenseRange) VALUES (0,0,1);--? Not sure what to put for values
insert into DefenseAssignments (CharacterIndex, AttributeIndex) VALUES (0,2);--? Not sure what to put for value
...
insert into ExploreCharacters (CharacterIndex, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) VALUES (0, 'Small', 'Shapeshift', 5, 3, '1B', '0', '2B', '3B', 5, 1);
...
insert into ExploreCharacters (CharacterIndex, ModelSize, CreatureType, Movement, Actions, Strength, Armor, Will, Dexterity, Health, Potions) VALUES (0, 'Small', 'Shapeshift', 6, 3, '2B1R', '1B1R', '2B', '2B', 6, 1);
...
insert into Characters (CardIndex) VALUES (0);
insert into KeywordAssignments (CharacterIndex, KeywordIndex) VALUES (1, 0); --? Not sure what to put here & check all values for this and the following
