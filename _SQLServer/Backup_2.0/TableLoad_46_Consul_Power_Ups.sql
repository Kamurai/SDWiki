...
insert into Utilities (CardIndex, UtilityDescription,) VALUES (cXXX, 'Play this card at the start of a scenario.  All monsters gain +1B to offense rolls during this scenario.');
