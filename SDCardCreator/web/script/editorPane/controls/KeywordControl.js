...
function KeywordControl(){
  ...
  this.template='<div class="hero monster pet treasure wonder loot arcadeSolo keywordEditor">'+
  	'<h2><a class="toggleDisplay" href=""><span class="uiKeyword">Keyword</span></a></h2>'+
    ...
    '</path></g><!-- react-empty: 6 --></svg></a>'+
  	'<div class="hero monster arcadeSolo">'+
  		'<span class="uiAffinity">Affinity</span> '+
  		'<select name="affinity">'+
  			'<option value="CITRINE" class="uiCitrine">Citrine</option>'+
  			'<option value="CITRINEAMETHYST" class="uiCitrineAmethyst">Citrine Amethyst</option>'+
  			'<option value="CITRINEEMERALD" class="uiCitrineEmerald">Citrine Emerald</option>'+
  			'<option value="CITRINERUBY" class="uiCitrineRuby">Citrine Ruby</option>'+
  			'<option value="CITRINESAPPHIRE" class="uiCitrineSapphire">Citrine Sapphire</option>'+
  			'<option disabled>----------</option>'+
  			'<option value="EMERALD" class="uiEmerald">Emerald</option>'+
  			'<option value="EMERALDAMETHYST" class="uiEmeraldAmethyst">Emerald Amethyst</option>'+
  			'<option value="EMERALDRUBY" class="uiEmeraldRuby">Emerald Ruby</option>'+
  			'<option value="EMERALDSAPPHIRE" class="uiEmeraldSapphire">Emerald Sapphire</option>'+
  			'<option disabled>----------</option>'+
  			'<option value="RUBY" class="uiRuby">Ruby</option>'+
  			'<option value="RUBYAMETHYST" class="uiRubyAmethyst">Ruby Amethyst</option>'+
  			'<option value="RUBYSAPPHIRE" class="uiRubySapphire">Ruby Sapphire</option>'+
  			'<option disabled>----------</option>'+
  			'<option value="SAPPHIRE" class="uiSapphire">Sapphire</option>'+
  			'<option value="SAPPHIREAMETHYST" class="uiSapphireAmethyst">Sapphire Amethyst</option>'+
  			'<option disabled>----------</option>'+
  			'<option value="AMETHYST" class="uiAmethyst">Amethyst</option>'+
  			'<option disabled>----------</option>'+
  			'<option value="none" class="uiNone">None</option>'+
  			'<option value="ALLAFFINITY" class="uiAll">All</option>'+
  		'</select>'+
  	'</div>'+

  	'<div><span class="uiKeywords">Keywords</span> <input name="keywordsList" required /></div>'+
    '</div>'+
  '</div>';
