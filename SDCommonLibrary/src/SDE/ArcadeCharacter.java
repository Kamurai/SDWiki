...
public class ArcadeCharacter extends Character{
    ...
    public void addGangMember(String name, int order, String creatureType, String rank, int movement, int health, int armor, String gender, String modelSize, String link, String pictureFront, String standeeFront, ArrayList<Keyword> keywords, ArrayList<Ability> abilities){
        addGangMember(new GangMember(name, order, creatureType, rank, movement, health, armor, gender, modelSize, link, pictureFront, standeeFront, keywords, abilities));
    }
